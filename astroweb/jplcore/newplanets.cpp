...
#define CTPLAN 8
const char *plans[CTPLAN] = {"MERC","VENS","MARS","JUPI","SATR","URAN","NEPT","PLUT"};
...
/*void printdegs(const char *name, double *rad)
{
 static const char *sigs[] = {"ARI","TAU","GEM","CAN","LEO","VIR","LIB","SCO","SAG","CAP","AQU","PIS", "ERR"};
