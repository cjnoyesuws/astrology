...
RECT_DATA birth_rectd, comp_rectd, trans_rectd, horary_rect;
RETURN_DATA return_data;
BIRTH_DB birth_rec, comp_rec, trans_rec, horary_rec;
LOC_DB reloc_data;
DIREC_DATA solar_data;
short birth_ok, birth_rect_ok = 1, comp_ok, comp_rect_ok = 1,
    trans_ok, trans_data_ok, prog_ok, horary_rect_ok=1;
AS_INF birth_inf[32], alt_inf[32], house_inf[12], alt_house_inf[12];
...
horary_dp= { NATAL_CH, &horary_rect, NULL, &progress_data, &return_data, &solar_data, &reloc_data, NULL, &m_harmonic, &m_dial };
