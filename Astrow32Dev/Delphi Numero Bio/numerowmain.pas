...
uses Windows, Classes, Graphics, Forms, Controls, Menus,
  ...
  ActnList, ToolWin, MRUFList, demo;
...
type
  TNumeroMain = class(TForm)
    ...
    procedure miDbMaintClick(Sender: TObject);
...
uses
  SysUtils, Mapi, about, SHFolder, NumDbMaint;
...
procedure TNumeroMain.miDbMaintClick(Sender: TObject);
begin
   NumDbMaintForm := TNumDbMaintForm.Create(Application);
   With NumDbMaintForm do
   begin
      ShowModal;
      Close;
      Free;
...
procedure TNumeroMain.FormShow(Sender: TObject);
begin
   {$IFDEF DEMO}
