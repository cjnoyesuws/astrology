...
uses
  ...
  Perpcal, Printers, inheritedregistry, ComCtrls, demo;
...
oReg.WriteString('StartMonth',edtSMo.Text );
calc;
end;
...
oReg.WriteString('StartYear',edtSYr.Text );
calc;
end;
...
scBig := oReg.ReadString('BigColor', cmbClrBig.Text );
...
begin
sHead := cmbHead.Text;
oReg.WriteString('HeadFont',sHead );
end;

procedure TfrmCal.cmbBigChange(Sender: TObject);
begin
sBig := cmbBig.Text;
oReg.WriteString('BigFont',sBig );
end;

procedure TfrmCal.cmbBaseChange(Sender: TObject);
begin
sBase := cmbBase.Text;
oReg.WriteString('BaseFont',sBase );
end;
...
oReg.WriteBool('PrintPortrait', prPortrait);
end;
...
oReg.WriteString('HeadColor', cmbClrHead.Text );
end;
...
oReg.WriteString('BigColor', cmbClrBig.Text );
end;
