...
extern const MIDL_SERVER_INFO INumerowCalcer_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO INumerowCalcer_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ITextGetter_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ITextGetter_ProxyInfo;
...
/* 594 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
...
/* Object interface: INumerowCalcer, ver. 0.0,
   GUID={0xB480AEC1,0x0F33,0x49B2,{0xAF,0x97,0xC8,0x9D,0xBD,0x20,0x6D,0x32}} */

#pragma code_seg(".orpc")
static const unsigned short INumerowCalcer_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO INumerowCalcer_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &INumerowCalcer_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO INumerowCalcer_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(23) _INumerowCalcerProxyVtbl = 
{
    &INumerowCalcer_ProxyInfo,
    &IID_INumerowCalcer,
    ...
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_Index */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_FirstName */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_MiddleName */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_LastName */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_BirthDate */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::CalcChart */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_TransStart */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_TransEnd */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_FontName */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_FontSize */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_FontCodes */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_FontColor */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_LeftMargin */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_TextWidth */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::put_DemoMode */ ,
    (void *) (INT_PTR) -1 /* INumerowCalcer::ConvertFile */
};


static const PRPC_STUB_FUNCTION INumerowCalcer_table[] =
{
...
CInterfaceStubVtbl _INumerowCalcerStubVtbl =
{
    &IID_INumerowCalcer,
    &INumerowCalcer_ServerInfo,
    23,
    &INumerowCalcer_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};


/* Object interface: ITextGetter, ver. 0.0,
   GUID={0x74EAD860,0x7971,0x4E4D,{0xB7,0xCD,0x1C,0x9C,0x9F,0x96,0xB8,0x54}} */

#pragma code_seg(".orpc")
static const unsigned short ITextGetter_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ITextGetter_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &ITextGetter_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ITextGetter_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(10) _ITextGetterProxyVtbl = 
{
    &ITextGetter_ProxyInfo,
    &IID_ITextGetter,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* ITextGetter::put_Row */ ,
    (void *) (INT_PTR) -1 /* ITextGetter::put_Col */ ,
    (void *) (INT_PTR) -1 /* ITextGetter::get_Text */
};


static const PRPC_STUB_FUNCTION ITextGetter_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ITextGetterStubVtbl =
{
    &IID_ITextGetter,
    &ITextGetter_ServerInfo,
    10,
    &ITextGetter_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
const CInterfaceProxyVtbl * __numerocalc_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ITextGetterProxyVtbl,
    ( CInterfaceProxyVtbl *) &_INumerowCalcerProxyVtbl,
    0
};

const CInterfaceStubVtbl * __numerocalc_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ITextGetterStubVtbl,
    ( CInterfaceStubVtbl *) &_INumerowCalcerStubVtbl,
    0
...
PCInterfaceName const __numerocalc_InterfaceNamesList[] = 
{
    "ITextGetter",
    "INumerowCalcer",
    0
...
const IID *  __numerocalc_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define __numerocalc_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __numerocalc, pIID, n)

int __stdcall __numerocalc_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( __numerocalc, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( __numerocalc, 2, *pIndex )
    
}

const ExtendedProxyFileInfo _numerocalc_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __numerocalc_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __numerocalc_StubVtblList,
    (const PCInterfaceName * ) & __numerocalc_InterfaceNamesList,
    (const IID ** ) & __numerocalc_BaseIIDList,
    & __numerocalc_IID_Lookup, 
    2,
    2,
