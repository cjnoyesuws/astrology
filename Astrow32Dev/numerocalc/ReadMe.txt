========================================================================
    ACTIVE TEMPLATE LIBRARY : numerocalc Project Overview
========================================================================

AppWizard has created this numerocalc project for you to use as the starting point for
...
_numerocalc.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_numerocalc.h)
        GUID definitions                                (_numerocalc_i.c)
        A type library                                  (_numerocalc.tlb)
        Marshaling code                                 (_numerocalc_p.c and dlldata.c)
numerocalc.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named numerocalc.pch and a precompiled types file named StdAfx.obj.
...
numerocalcps.vcproj
	...
	dlldata.c, numerocalc_i.c and numerocalc_p.c which are required
