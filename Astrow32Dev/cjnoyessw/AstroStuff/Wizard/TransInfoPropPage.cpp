// TransInfoPropPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CTransInfoPropPage dialog

IMPLEMENT_DYNAMIC(CTransInfoPropPage, CPropertyPage)
CTransInfoPropPage::CTransInfoPropPage()
	: CPropertyPage(CTransInfoPropPage::IDD,0)
{
	//{{AFX_DATA_INIT(CTransInfoPropPage)
	m_ampm = -1;
	m_day = 0;
	m_hr = 0;
	m_min = 0;
...
void CTransInfoPropPage::DoDataExchange(CDataExchange* pDX)
{

	CDialog::DoDataExchange(pDX);
	if ( !pDX->m_bSaveAndValidate )
		m_gmthr = tim_vals[m_timezone];
	//{{AFX_DATA_MAP(CTransInfoPropPage)
...
BEGIN_MESSAGE_MAP(CTransInfoPropPage, CDialog)
	//{{AFX_MSG_MAP(CTransInfoPropPage)
...
/////////////////////////////////////////////////////////////////////////////
// CTransInfoPropPage message handlers

void CTransInfoPropPage::OnSelchangeBiname()
{
	...
	m_name.TrimRight();
	GetData(trans);
	pTransitDb->setBirth(*(((CChartWizard *)GetParent())->GetChartDataPtrs().birth));
...
void CTransInfoPropPage::OnSelchangeRltimezone()
{
	// TODO: Add your control notification handler code here
CString txt;
...
void CTransInfoPropPage::OnKillfocusRlstate()
{
	// TODO: Add your control notification handler code here
	int sel;
	long lrec;
...
void CTransInfoPropPage::OnKillfocusRlcountry()
{
	// TODO: Add your control notification handler code here
	int sel;
	long lrec;
...
void CTransInfoPropPage::OnRlmenu()
{
	// TODO: Add your control notification handler code here
if ( pMenu != NULL )
   delete pMenu;
...
BOOL CTransInfoPropPage::OnCommand(WPARAM wParam, LPARAM lParam)
{
...
BOOL CTransInfoPropPage::OnInitDialog()
{
...
void CTransInfoPropPage::OnSelchangeRllocation()
{
	// TODO: Add your control notification handler code here
	int sel;
	LOC_DB db;
...
void CTransInfoPropPage::SetData( LOC_DB &l )
{
m_country = l.country;
m_state = l.state;
...
void CTransInfoPropPage::GetData( LOC_DB &l )
{
...
void CTransInfoPropPage::OnEditchangeRlcountry()
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLCOUNTRY);
...
void CTransInfoPropPage::OnSelchangeRlcountry()
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLCOUNTRY);
int sel = pco->GetCurSel();
...
void CTransInfoPropPage::OnEditchangeRllocation()
{
	// TODO: Add your control notification handler code here
...
void CTransInfoPropPage::OnSelchangeRlstate()
{
	// TODO: Add your control notification handler code here
...
void CTransInfoPropPage::OnEditchangeRlstate()
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLSTATE);
int sel = pco->GetCurSel();
...
BOOL CTransInfoPropPage::DestroyWindow()
{
	// TODO: Add your specialized code here and/or call the base class
...
void CTransInfoPropPage::SetData( BIRTH_DB &b)
{
m_ampm =b.am_pm;
m_country = b.country;
m_name = b.name;
...
void CTransInfoPropPage::GetData( BIRTH_DB &b)
{
adjustTime();
b.am_pm = m_ampm;
...
void CTransInfoPropPage::OnEditchangeBiname()
{
	// TODO: Add your control notification handler code here
	int sel;
	CComboBox *pco = (CComboBox *)GetDlgItem(ID_BINAME);
...
void CTransInfoPropPage::preAdjustTime()
{
 if ( !m_ampm ) {
    if ( m_hr == 12 )
       m_ampm = 1;
...
void CTransInfoPropPage::adjustTime()
{
 if ( m_ampm && m_hr != 12 )
    m_hr += 12;
...
void CTransInfoPropPage::updateCombos()
{

}


void CTransInfoPropPage::showGmtCtl(int bShow)
{
  if ( bShow) {
...
void CTransInfoPropPage::doClipboard()
{
...
LRESULT CTransInfoPropPage::OnWizardNext()
{
	// TODO: Add your specialized code here and/or call the base class
        LOC_DB loc;
	BIRTH_DB trans;
	...
	if ( m_name.Trim().GetLength()==0) {
	   AfxMessageBox("You Must Give the Transit Event a Name");
	   return -1;
	}
	COleDateTime thedate(m_year, m_mo, m_day, m_hr, m_min, 0 );
	int dst = IsInDaylightSavings(thedate);
...
BOOL CTransInfoPropPage::OnWizardFinish()
{
	// TODO: Add your specialized code here and/or call the base class
    UpdateData(TRUE);
    GetData(*(((CChartWizard *)GetParent())->GetChartDataPtrs().trans));
    return CPropertyPage::OnWizardFinish();
}

LRESULT CTransInfoPropPage::OnWizardBack()
{
	// TODO: Add your specialized code here and/or call the base class
...
BOOL CTransInfoPropPage::OnSetActive()
{
	// TODO: Add your specialized code here and/or call the base class
    SetData(*(((CChartWizard *)GetParent())->GetChartDataPtrs().trans));
    UpdateData(FALSE);
    CTransitComboBox *pnm = new CTransitComboBox((CComboBox *)GetDlgItem(ID_BINAME));
	pnm->loadList(CString(((CChartWizard *)GetParent())->GetChartDataPtrs().birth->name ));
 	delete pnm;
    ((CChartWizard *)GetParent())->HandleButtons();
    return CPropertyPage::OnSetActive();
}

BOOL CTransInfoPropPage::OnKillActive()
{
	// TODO: Add your specialized code here and/or call the base class
