// RelocScrPropPage.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CRelocScrPropPage, CPropertyPage)
CRelocScrPropPage::CRelocScrPropPage()
	: CPropertyPage(CRelocScrPropPage::IDD, 0)
{
	//{{AFX_DATA_INIT(CRelocScrPropPage)
	m_country = _T("");
	m_eastwest = -1;
	m_location = _T("");
	m_speccode = -1;
...
void CRelocScrPropPage::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	if ( !pDX->m_bSaveAndValidate )
		m_gmthr = tim_vals[m_timezone];
	//{{AFX_DATA_MAP(CRelocScrPropPage)
...
BEGIN_MESSAGE_MAP(CRelocScrPropPage, CDialog)
	//{{AFX_MSG_MAP(CRelocScrPropPage)
...
/////////////////////////////////////////////////////////////////////////////
// CRelocScrPropPage message handlers

void CRelocScrPropPage::OnSelchangeRltimezone()
{
...
void CRelocScrPropPage::OnSelchangeRlpersonal()
{
	// TODO: Add your control notification handler code here
  LOC_DB db;
  ...
  UpdateData(TRUE);
  m_personal = per;
  pRelocDb->setBirth( *(((CChartWizard *)GetParent())->GetChartDataPtrs().birth) );
...
void CRelocScrPropPage::OnEditchangeRlpersonal()
{
	// TODO: Add your control notification handler code here
 CComboBox *pco = (CComboBox *)GetDlgItem(IDC_RELOCS);
 int sel = pco->GetCurSel();
...
void CRelocScrPropPage::OnSelchangeRlspeccode()
{
	// TODO: Add your control notification handler code here

}

void CRelocScrPropPage::OnKillfocusRlstate()
{
	// TODO: Add your control notification handler code here
	int sel;
	long lrec;
...
void CRelocScrPropPage::OnKillfocusRlcountry()
{
	// TODO: Add your control notification handler code here
	int sel;
	long lrec;
...
void CRelocScrPropPage::OnKillfocusRllocation()
{
	// TODO: Add your control notification handler code here
...
void CRelocScrPropPage::OnRlmenu()
{
	// TODO: Add your control notification handler code here
if ( pMenu != NULL )
   delete pMenu;
...
BOOL CRelocScrPropPage::OnCmdMsg(UINT nID, int nCode, void* pExtra, AFX_CMDHANDLERINFO* pHandlerInfo)
{
...
BOOL CRelocScrPropPage::OnCommand(WPARAM wParam, LPARAM lParam)
{
	// TODO: Add your specialized code here and/or call the base class
LOC_DB db;
...
BOOL CRelocScrPropPage::OnInitDialog()
{
...
void CRelocScrPropPage::OnSelchangeRllocation()
{
	// TODO: Add your control notification handler code here
	int sel;
	LOC_DB db;
...
void CRelocScrPropPage::SetData( LOC_DB &l )
{
m_country = l.country;
m_state = l.state;
...
void CRelocScrPropPage::GetData( LOC_DB &l )
{
...
void CRelocScrPropPage::OnEditchangeRlcountry()
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLCOUNTRY);
int sel = pco->GetCurSel();
...
void CRelocScrPropPage::OnSelchangeRlcountry()
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLCOUNTRY);
int sel = pco->GetCurSel();
...
void CRelocScrPropPage::OnEditchangeRllocation()
{
	// TODO: Add your control notification handler code here
...
void CRelocScrPropPage::OnSelchangeRlstate()
{
	// TODO: Add your control notification handler code here
...
void CRelocScrPropPage::OnEditchangeRlstate()
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLSTATE);
int sel = pco->GetCurSel();
...
BOOL CRelocScrPropPage::DestroyWindow()
{
	// TODO: Add your specialized code here and/or call the base class
...
void CRelocScrPropPage::WinHelp(DWORD dwData, UINT nCmd)
{
	// TODO: Add your specialized code here and/or call the base class

	CDialog::WinHelp(CRelocScrPropPage::IDD, HELP_CONTEXT);
}


void CRelocScrPropPage::OnOK()
{
	LOC_DB loc;
	// TODO: Add your control notification handler code here
...
void CRelocScrPropPage::showGmtCtl(int bShow)
{
  if ( bShow) {
...
void CRelocScrPropPage::doClipboard()
{
...
LRESULT CRelocScrPropPage::OnWizardNext()
{
	// TODO: Add your specialized code here and/or call the base class
    UpdateData(TRUE);
    if ( m_ladeg > 60 ) {
	   AfxMessageBox("Don't Use Koch Or Placidus as the Latitude is too High!" );
	   ((CChartWizard *)GetParent())->NorthLatitude() = TRUE;
	}
    LOC_DB loc;
	if ( bLocModified ) {
...
BOOL CRelocScrPropPage::OnWizardFinish()
{
	// TODO: Add your specialized code here and/or call the base class
    UpdateData(TRUE);
    GetData(*(((CChartWizard *)GetParent())->GetChartDataPtrs().reloc));
    *(((CChartWizard *)GetParent())->GetChartDataPtrs().relocpers)= m_personal;
    return CPropertyPage::OnWizardFinish();
}

LRESULT CRelocScrPropPage::OnWizardBack()
{
	// TODO: Add your specialized code here and/or call the base class
...
BOOL CRelocScrPropPage::OnSetActive()
{
	// TODO: Add your specialized code here and/or call the base class
    SetData(*(((CChartWizard *)GetParent())->GetChartDataPtrs().reloc));
    UpdateData(FALSE);
    CRelocateComboBox *prlo = new CRelocateComboBox((CComboBox *)GetDlgItem(IDC_RELOCS));
	prlo->loadList(CString(((CChartWizard *)GetParent())->GetChartDataPtrs().birth->name ));
    delete prlo;
    CComboBox *pco = (CComboBox *)GetDlgItem(IDC_RELOCS);
    if ( pco->SelectString(0,*(((CChartWizard *)GetParent())->GetChartDataPtrs().relocpers)) == CB_ERR)
       pco->SetWindowText(*(((CChartWizard *)GetParent())->GetChartDataPtrs().relocpers));
    ((CChartWizard *)GetParent())->HandleButtons();
    return CPropertyPage::OnSetActive();
}

BOOL CRelocScrPropPage::OnKillActive()
{
	// TODO: Add your specialized code here and/or call the base class
