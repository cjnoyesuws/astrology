// TransInfoPropPage.h : header file
//
#pragma once
#include "afxwin.h"
/////////////////////////////////////////////////////////////////////////////
...
class CTransInfoPropPage : public CPropertyPage
{
  DECLARE_DYNAMIC(CTransInfoPropPage)
// Construction
public:
	CTransInfoPropPage();   // standard constructor
	virtual ~CTransInfoPropPage() { DestroyWindow(); }
...
// Dialog Data
	//{{AFX_DATA(CTransInfoPropPage)
	enum { IDD = IDD_TRANS_INFO_PROP_PAGE };
	int		m_ampm;
	int	m_day;
	int	m_hr;
	int	m_min;
...
// Overrides
	...
	//{{AFX_VIRTUAL(CTransInfoPropPage)
	public:
