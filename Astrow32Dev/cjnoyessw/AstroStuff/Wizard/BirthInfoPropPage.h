...
class CBirthInfoPropPage : public CPropertyPage
{
	DECLARE_DYNAMIC(CBirthInfoPropPage)
// Construction
public:
	CBirthInfoPropPage();   // standard constructor
	virtual ~CBirthInfoPropPage() {DestroyWindow(); }
	CBirthInfoPropPage(UINT nIdResource);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CBirthInfoPropPage)
	enum { IDD = IDD_BIRTH_INF_PROP_PAGE };
	CString	m_country;
	int		m_eastwest;
	int	m_gmthr;
	int	m_gmtmin;
...
// Overrides
	...
	//{{AFX_VIRTUAL(CBirthInfoPropPage)
	public:
