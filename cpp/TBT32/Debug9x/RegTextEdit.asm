...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0EK@DDELNJBI@select?5?$CK?5from?5RegularText?5where?5@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
; 31   :    pFuncs = new RTFFuncs(this);
	...
	cmp	DWORD PTR $T94356[ebp], 0
	je	SHORT $L94357
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T94356[ebp]
...
$L94358:
	...
	mov	DWORD PTR $T94355[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 7
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR $T94355[ebp]
...
EXTRN	?DDX_CBString@@YGXPAVCDataExchange@@HAAV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@@Z:NEAR ; DDX_CBString
...
; 40   : 	DDX_CBString(pDX, IDC_KEY2, m_Key2);
	...
	mov	ecx, DWORD PTR _pDX$[ebp]
	push	ecx
	call	?DDX_CBString@@YGXPAVCDataExchange@@HAAV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@@Z ; DDX_CBString
...
PUBLIC	??_C@_0EK@DDELNJBI@select?5?$CK?5from?5RegularText?5where?5@ ; `string'
...
;	COMDAT ??_C@_0EK@DDELNJBI@select?5?$CK?5from?5RegularText?5where?5@
CONST	SEGMENT
??_C@_0EK@DDELNJBI@select?5?$CK?5from?5RegularText?5where?5@ DB 'select *'
...
$T94519 = -972						; size = 4
_e$94104 = -768						; size = 4
_Lang$94095 = -756					; size = 4
_key2$ = -744						; size = 25
_key1$ = -708						; size = 25
_sqlbuf$ = -672						; size = 125
...
; 318  : 	CString Lang = GetCurLanguage();
	...
	push	eax
	lea	ecx, DWORD PTR _Lang$94095[ebp]
...
; 328  :       key1, key2, (LPCTSTR)m_TextType);
	...
	push	ecx
	push	OFFSET FLAT:??_C@_0EK@DDELNJBI@select?5?$CK?5from?5RegularText?5where?5@
...
; 340  :    e->GetErrorMessage(errbuf,499);
	...
	push	eax
	mov	ecx, DWORD PTR _e$94104[ebp]
...
; 369  :    CSymbol *pSym=pRegSymbols->Find(key1,1,0);
	...
	mov	DWORD PTR _pSym$94121[ebp], ecx

; 370  :    if ( pSym == NULL ) {

	cmp	DWORD PTR _pSym$94121[ebp], 0
	jne	SHORT $L94122
...
; 374  :    theSet.m_Key1num=pSym->value();
	...
	mov	ecx, DWORD PTR _pSym$94121[ebp]
...
; 423  :     delete pFuncs;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+396]
	mov	DWORD PTR $T94595[ebp], ecx
	mov	edx, DWORD PTR $T94595[ebp]
	mov	DWORD PTR $T94594[ebp], edx
	cmp	DWORD PTR $T94594[ebp], 0
	je	SHORT $L94596
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T94594[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T94594[ebp]
	call	DWORD PTR [edx]
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$94165[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$94165[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
