...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BI@EHFGLALK@texttype?0textkey?0iIndex?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0L@EBJCPBPF@ReportText?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_04NEKJKOGG@?4AST?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_02FDNPDKF@1?9?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??1CReptDbExport@@UAE@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Process@CReptDbExport@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
PUBLIC	??1CReptDbExport@@UAE@XZ			; CReptDbExport::~CReptDbExport
PUBLIC	?Process@CReptDbExport@@UAEXXZ			; CReptDbExport::Process
...
;	COMDAT rtc$IMZ
; File c:\astrow32dev\tbt32\reptdbexport.cpp
rtc$IMZ	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??1CReptDbExport@@UAE@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??1CReptDbExport@@UAE@XZ$0
	DD	00H
	DD	FLAT:__unwindfunclet$??1CReptDbExport@@UAE@XZ$1
__ehfuncinfo$??1CReptDbExport@@UAE@XZ DD 019930520H
	DD	02H
	DD	FLAT:__unwindtable$??1CReptDbExport@@UAE@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
xdata$x	ENDS
;	COMDAT ??_7CReptDbExport@@6B@
...
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
??1CReptDbExport@@UAE@XZ PROC NEAR			; CReptDbExport::~CReptDbExport, COMDAT
; _this$ = ecx
...
; 6    : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??1CReptDbExport@@UAE@XZ
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??1CReptDbExport@@UAE@XZ$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1CBaseDbExport@@UAE@XZ		; CBaseDbExport::~CBaseDbExport
__unwindfunclet$??1CReptDbExport@@UAE@XZ$1:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
	jmp	??1CDReportText@@UAE@XZ
__ehhandler$??1CReptDbExport@@UAE@XZ:
	mov	eax, OFFSET FLAT:__ehfuncinfo$??1CReptDbExport@@UAE@XZ
	jmp	___CxxFrameHandler
text$x	ENDS
??1CReptDbExport@@UAE@XZ ENDP				; CReptDbExport::~CReptDbExport
...
PUBLIC	??_C@_0BI@EHFGLALK@texttype?0textkey?0iIndex?$AA@ ; `string'
PUBLIC	??_C@_01GEODFPGF@?8?$AA@			; `string'
PUBLIC	??_C@_06FEBFCBED@Lang?$DN?8?$AA@		; `string'
PUBLIC	??_C@_0L@EBJCPBPF@ReportText?$AA@		; `string'
PUBLIC	??_C@_04NEKJKOGG@?4AST?$AA@			; `string'
PUBLIC	??_C@_02FDNPDKF@1?9?$AA@			; `string'
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?Process@CReptDbExport@@UAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$2
	DD	00H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$3
	DD	01H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$4
	DD	02H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$5
	DD	03H
	DD	00H
	DD	04H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$6
	DD	05H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$7
	DD	06H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$8
	DD	07H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$9
	DD	06H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$10
	DD	09H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$11
	DD	09H
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$12
	DD	0bH
	DD	FLAT:__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$13
	DD	03H
	DD	00H
__catchsym$?Process@CReptDbExport@@UAEXXZ$14 DD 00H
	DD	FLAT:??_R0PAVCDaoException@@@8
	DD	0fffffd88H
	DD	FLAT:__catch$?Process@CReptDbExport@@UAEXXZ$0
__tryblocktable$?Process@CReptDbExport@@UAEXXZ DD 04H
	DD	0cH
	DD	0dH
	DD	01H
	DD	FLAT:__catchsym$?Process@CReptDbExport@@UAEXXZ$14
__ehfuncinfo$?Process@CReptDbExport@@UAEXXZ DD 019930520H
	DD	0eH
	DD	FLAT:__unwindtable$?Process@CReptDbExport@@UAEXXZ
	DD	01H
	DD	FLAT:__tryblocktable$?Process@CReptDbExport@@UAEXXZ
	DD	2 DUP(00H)
xdata$x	ENDS
;	COMDAT ??_C@_00CNPNBAHC@?$AA@
CONST	SEGMENT
...
;	COMDAT ??_C@_0BI@EHFGLALK@texttype?0textkey?0iIndex?$AA@
CONST	SEGMENT
??_C@_0BI@EHFGLALK@texttype?0textkey?0iIndex?$AA@ DB 'texttype,textkey,iI'
	DB	'ndex', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_06FEBFCBED@Lang?$DN?8?$AA@
CONST	SEGMENT
...
;	COMDAT ??_C@_0L@EBJCPBPF@ReportText?$AA@
CONST	SEGMENT
??_C@_0L@EBJCPBPF@ReportText?$AA@ DB 'ReportText', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_02FDNPDKF@1?9?$AA@
CONST	SEGMENT
??_C@_02FDNPDKF@1?9?$AA@ DB '1-', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_04NEKJKOGG@?4AST?$AA@
CONST	SEGMENT
...
$T93351 = -836						; size = 4
_e$93150 = -632						; size = 4
_strTable$93135 = -620					; size = 4
_strFilter$93126 = -608					; size = 4
_strSort$93124 = -596					; size = 4
_plu$ = -584						; size = 4
_h3$ = -572						; size = 4
_h2$ = -560						; size = 4
_type$ = -548						; size = 4
...
?Process@CReptDbExport@@UAEXXZ PROC NEAR		; CReptDbExport::Process, COMDAT
; _this$ = ecx
...
; 12   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Process@CReptDbExport@@UAEXXZ
	mov	eax, DWORD PTR fs:__except_list
	push	eax
	mov	DWORD PTR fs:__except_list, esp
	push	ecx
...
; 15   :  CString h2 = "", h3 = "", plu = "+";
	...
	push	OFFSET FLAT:??_C@_00CNPNBAHC@?$AA@
	lea	ecx, DWORD PTR _h3$[ebp]
	call	??0?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@PBD@Z ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	BYTE PTR __$EHRec$[ebp+12], 2
	push	OFFSET FLAT:??_C@_01MIFGBAGJ@?$CL?$AA@
	lea	ecx, DWORD PTR _plu$[ebp]
	call	??0?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@PBD@Z ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
...
; 17   :     CString strSort = "texttype,textkey,iIndex";

	push	OFFSET FLAT:??_C@_0BI@EHFGLALK@texttype?0textkey?0iIndex?$AA@
	lea	ecx, DWORD PTR _strSort$93124[ebp]
	call	??0?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@PBD@Z ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	DWORD PTR tv76[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 5

; 18   :     CString strFilter = "";

	push	OFFSET FLAT:??_C@_00CNPNBAHC@?$AA@
	lea	ecx, DWORD PTR _strFilter$93126[ebp]
	call	??0?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@PBD@Z ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	DWORD PTR tv72[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 6

; 19   : 	if ( m_Lang.GetLength() ) {
...
; 21   :        }
; 22   :     CString strTable = "ReportText";

	push	OFFSET FLAT:??_C@_0L@EBJCPBPF@ReportText?$AA@
	lea	ecx, DWORD PTR _strTable$93135[ebp]
	call	??0?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@PBD@Z ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	DWORD PTR tv260[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 9

; 23   : 	set.Open(dbOpenDynaset,MakeSQL(strTable,strFilter,strSort));

	lea	eax, DWORD PTR _strSort$93124[ebp]
	push	eax
	lea	ecx, DWORD PTR _strFilter$93126[ebp]
	push	ecx
	lea	edx, DWORD PTR _strTable$93135[ebp]
	push	edx
	lea	eax, DWORD PTR $T93349[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 28   : 		   OpenFile("1-" + set.m_texttype + ".AST");

	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 180				; 000000b4H
	push	eax
	push	OFFSET FLAT:??_C@_02FDNPDKF@1?9?$AA@
	lea	ecx, DWORD PTR $T93350[ebp]
	push	ecx
	call	??HATL@@YA?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@0@PBDABV10@@Z ; ATL::operator+
	add	esp, 12					; 0000000cH
...
; 31   :            WriteHeader(set.m_textkey,h2,h3);

	lea	eax, DWORD PTR _h3$[ebp]
	push	eax
	lea	ecx, DWORD PTR _h2$[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 33   : 		   WriteHeader(plu,h2,h3);

	lea	eax, DWORD PTR _h3$[ebp]
	push	eax
	lea	ecx, DWORD PTR _h2$[ebp]
	push	ecx
	lea	edx, DWORD PTR _plu$[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?WriteHeader@CBaseDbExport@@QAEXAAV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@00@Z ; CBaseDbExport::WriteHeader
$L93148:
...
; 41   :  }
	...
	lea	ecx, DWORD PTR _strSort$93124[ebp]
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	jmp	__tryend$?Process@CReptDbExport@@UAEXXZ$1
__catch$?Process@CReptDbExport@@UAEXXZ$0:

; 42   :  catch ( CDaoException *e ) {
; 43   :    e->GetErrorMessage(errbuf,499);
	...
	push	eax
	mov	ecx, DWORD PTR _e$93150[ebp]
...
; 44   :    alert_box(_T("Error on Database"), errbuf );
...
$L93366:
	...
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	jmp	SHORT $L93116
__tryend$?Process@CReptDbExport@@UAEXXZ$1:
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$2:
	lea	ecx, DWORD PTR _type$[ebp]
...
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$3:
	lea	ecx, DWORD PTR _h2$[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$4:
	lea	ecx, DWORD PTR _h3$[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$5:
	lea	ecx, DWORD PTR _plu$[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$6:
	lea	ecx, DWORD PTR _strSort$93124[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$7:
	lea	ecx, DWORD PTR _strFilter$93126[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$8:
	lea	ecx, DWORD PTR $T93347[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$9:
	lea	ecx, DWORD PTR $T93348[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$10:
	lea	ecx, DWORD PTR _strTable$93135[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$11:
	lea	ecx, DWORD PTR $T93349[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$12:
	lea	ecx, DWORD PTR $T93350[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?Process@CReptDbExport@@UAEXXZ$13:
	lea	ecx, DWORD PTR $T93351[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__ehhandler$?Process@CReptDbExport@@UAEXXZ:
	mov	eax, OFFSET FLAT:__ehfuncinfo$?Process@CReptDbExport@@UAEXXZ
	jmp	___CxxFrameHandler
text$x	ENDS
?Process@CReptDbExport@@UAEXXZ ENDP			; CReptDbExport::Process
...
; 2028 : 		return( strResult );
	...
	mov	ecx, DWORD PTR $T93398[ebp]
	or	ecx, 1
	mov	DWORD PTR $T93398[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _strResult$[ebp]
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
...
; 2037 : 		return( strResult );
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@ABV01@@Z ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	ecx, DWORD PTR $T93413[ebp]
	or	ecx, 1
	mov	DWORD PTR $T93413[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _strResult$[ebp]
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$93178[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$93178[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
