...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?PreCreateWindow@CChildView@@MAEHAAUtagCREATESTRUCTA@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
PUBLIC	?PreCreateWindow@CChildView@@MAEHAAUtagCREATESTRUCTA@@@Z ; CChildView::PreCreateWindow
...
??_7CChildView@@6B@ DD FLAT:?GetRuntimeClass@CWnd@@UBEPAUCRuntimeClass@@XZ ; CChildView::`vftable'
	...
	DD	FLAT:?PreCreateWindow@CChildView@@MAEHAAUtagCREATESTRUCTA@@@Z
...
_this$ = -8						; size = 4
_cs$ = 8						; size = 4
?PreCreateWindow@CChildView@@MAEHAAUtagCREATESTRUCTA@@@Z PROC NEAR ; CChildView::PreCreateWindow, COMDAT
; _this$ = ecx
...
; 38   : 	if (!CWnd::PreCreateWindow(cs))
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?PreCreateWindow@CWnd@@UAEHAAUtagCREATESTRUCTA@@@Z ; CWnd::PreCreateWindow
	test	eax, eax
	jne	SHORT $L93005
...
; 47   : }
	...
	pop	ebp
	ret	4
?PreCreateWindow@CChildView@@MAEHAAUtagCREATESTRUCTA@@@Z ENDP ; CChildView::PreCreateWindow
_TEXT	ENDS
