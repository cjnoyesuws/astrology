...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0L@LPJCLCJ@?$FLHelpText?$FN?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_08BGENIFOO@?$FLiChunk?$FN?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDefaultDBName@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDefaultSQL@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
PUBLIC	?GetDefaultDBName@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ ; CDHelpTxt::GetDefaultDBName
PUBLIC	?GetDefaultSQL@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ ; CDHelpTxt::GetDefaultSQL
...
??_7CDHelpTxt@@6B@ DD FLAT:?GetRuntimeClass@CDHelpTxt@@UBEPAUCRuntimeClass@@XZ ; CDHelpTxt::`vftable'
	...
	DD	FLAT:?GetDefaultDBName@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ
	DD	FLAT:?GetDefaultSQL@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ
...
?GetDefaultDBName@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ PROC NEAR ; CDHelpTxt::GetDefaultDBName, COMDAT
; _this$ = ecx
...
; 37   : 	return GetDatabaseNamePath();
	...
	add	esp, 4
	mov	ecx, DWORD PTR $T93248[ebp]
	or	ecx, 1
	mov	DWORD PTR $T93248[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 38   : }
	...
	pop	ebp
	ret	4
?GetDefaultDBName@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ ENDP ; CDHelpTxt::GetDefaultDBName
_TEXT	ENDS
...
PUBLIC	??_C@_0L@LPJCLCJ@?$FLHelpText?$FN?$AA@		; `string'
;	COMDAT ??_C@_0L@LPJCLCJ@?$FLHelpText?$FN?$AA@
CONST	SEGMENT
??_C@_0L@LPJCLCJ@?$FLHelpText?$FN?$AA@ DB '[HelpText]', 00H ; `string'
; Function compile flags: /Odt /RTCcsu /ZI
CONST	ENDS
;	COMDAT ?GetDefaultSQL@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT
...
_this$ = -8						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetDefaultSQL@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ PROC NEAR ; CDHelpTxt::GetDefaultSQL, COMDAT
; _this$ = ecx
...
; 41   : {
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T93253[ebp], 0

; 42   : 	return _T("[HelpText]");

	push	OFFSET FLAT:??_C@_0L@LPJCLCJ@?$FLHelpText?$FN?$AA@
	...
	mov	eax, DWORD PTR $T93253[ebp]
	or	eax, 1
	mov	DWORD PTR $T93253[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 43   : }
	...
	pop	ebp
	ret	4
?GetDefaultSQL@CDHelpTxt@@UAE?AV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ ENDP ; CDHelpTxt::GetDefaultSQL
_TEXT	ENDS
...
PUBLIC	??_C@_08BGENIFOO@?$FLiChunk?$FN?$AA@		; `string'
...
;	COMDAT ??_C@_08BGENIFOO@?$FLiChunk?$FN?$AA@
CONST	SEGMENT
??_C@_08BGENIFOO@?$FLiChunk?$FN?$AA@ DB '[iChunk]', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_06GPNHHKK@?$FLLang?$FN?$AA@
CONST	SEGMENT
...
; 51   : 	DFX_Short(pFX,_T("[iChunk]"),m_iChunk );
	...
	push	eax
	push	OFFSET FLAT:??_C@_08BGENIFOO@?$FLiChunk?$FN?$AA@
	mov	ecx, DWORD PTR _pFX$[ebp]
	push	ecx
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$93111[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$93111[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
