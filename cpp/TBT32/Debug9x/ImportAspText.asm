...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0GN@DMEHEIJB@select?5?$CK?5from?5AspectText?5where?5P@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Process@ImportAspText@@QAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??_GCTextBlockAry@@QAEPAXI@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?__LINE__Var@?1??Process@ImportAspText@@QAEXXZ@4JA
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
...
_DATA	SEGMENT
_THIS_FILE DB	'c:\astrow32dev\tbt32\importasptext.cpp', 00H
_DATA	ENDS
;	COMDAT ?g_pfnGetThreadACP@ATL@@3P6GIXZA
_DATA	SEGMENT
...
_TEXT	ENDS
PUBLIC	?Process@ImportAspText@@QAEXXZ			; ImportAspText::Process
PUBLIC	?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z ; ImportAspText::ProcessItem
PUBLIC	??_C@_01KICIPPFI@?2?$AA@			; `string'
PUBLIC	??_C@_04NEKJKOGG@?4AST?$AA@			; `string'
PUBLIC	?__LINE__Var@?1??Process@ImportAspText@@QAEXXZ@4JA ; `ImportAspText::Process'::`2'::__LINE__Var
...
;	COMDAT xdata$x
; File c:\astrow32dev\tbt32\importasptext.cpp
xdata$x	SEGMENT
__unwindtable$?Process@ImportAspText@@QAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@ImportAspText@@QAEXXZ$1
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@ImportAspText@@QAEXXZ$2
__ehfuncinfo$?Process@ImportAspText@@QAEXXZ DD 019930520H
	DD	02H
	DD	FLAT:__unwindtable$?Process@ImportAspText@@QAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
xdata$x	ENDS
;	COMDAT ??_C@_01KICIPPFI@?2?$AA@
...
;	COMDAT ?__LINE__Var@?1??Process@ImportAspText@@QAEXXZ@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Process@ImportAspText@@QAEXXZ@4JA DD 01dH ; `ImportAspText::Process'::`2'::__LINE__Var
; Function compile flags: /Odt /RTCcsu /ZI
_DATA	ENDS
;	COMDAT ?Process@ImportAspText@@QAEXXZ
_TEXT	SEGMENT
...
?Process@ImportAspText@@QAEXXZ PROC NEAR		; ImportAspText::Process, COMDAT
; _this$ = ecx
...
; 29   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Process@ImportAspText@@QAEXXZ
...
; 33   : 	  strcpy(path, (const char *) m_dir );
...
; 35   :     strcpy(path, (const char *) GetSrcDir() );

	lea	eax, DWORD PTR $T93729[ebp]
	push	eax
	...
	call	_strcpy
	add	esp, 8
	lea	ecx, DWORD PTR $T93729[ebp]
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
$L93509:

; 36   : #else
; 37   :  memset(path, 0, 500);
; 38   :  if ( m_dir.GetLength() > 0 ) 
; 39   : 	 wcstombs(path, m_dir, m_dir.GetLength() );
; 40   :  else
; 41   : 	 wcstombs(path,GetSrcDir(),GetSrcDir().GetLength() );
; 42   :  path[GetSrcDir().GetLength()] = '\0';
; 43   : #endif
...
; 48   :  m_pProg->SetFile(CString(filename));

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+196]
	push	ecx
	lea	ecx, DWORD PTR $T93730[ebp]
...
; 49   :  CTextBlockAry *pAry= new CTextBlockAry(3,1000);

	mov	eax, DWORD PTR ?__LINE__Var@?1??Process@ImportAspText@@QAEXXZ@4JA
...
$L93734:
	...
	mov	DWORD PTR $T93731[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T93731[ebp]
...
; 51   :     delete pAry;
	...
	mov	DWORD PTR $T93736[ebp], eax
	mov	ecx, DWORD PTR $T93736[ebp]
	mov	DWORD PTR $T93735[ebp], ecx
	cmp	DWORD PTR $T93735[ebp], 0
	je	SHORT $L93737
	push	1
...
; 58   :     if ( !ProcessItem(pBlk) )
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z ; ImportAspText::ProcessItem
	test	eax, eax
	jne	SHORT $L93531
...
; 61   :  delete pAry;
	...
	mov	eax, DWORD PTR _pAry$[ebp]
	mov	DWORD PTR $T93740[ebp], eax
	mov	ecx, DWORD PTR $T93740[ebp]
	mov	DWORD PTR $T93739[ebp], ecx
	cmp	DWORD PTR $T93739[ebp], 0
	je	SHORT $L93741
	push	1
	mov	ecx, DWORD PTR $T93739[ebp]
	call	??_GCTextBlockAry@@QAEPAXI@Z
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?Process@ImportAspText@@QAEXXZ$1:
	lea	ecx, DWORD PTR $T93730[ebp]
...
__unwindfunclet$?Process@ImportAspText@@QAEXXZ$2:
	mov	eax, DWORD PTR ?__LINE__Var@?1??Process@ImportAspText@@QAEXXZ@4JA
	add	eax, 20					; 00000014H
	push	eax
	push	OFFSET FLAT:_THIS_FILE
	...
	add	esp, 12					; 0000000cH
	ret	0
__ehhandler$?Process@ImportAspText@@QAEXXZ:
	mov	eax, OFFSET FLAT:__ehfuncinfo$?Process@ImportAspText@@QAEXXZ
	jmp	___CxxFrameHandler
text$x	ENDS
?Process@ImportAspText@@QAEXXZ ENDP			; ImportAspText::Process
...
; 43   : 	CTextBlockAry(int tp, int size) { _type = tp; _bDirty = 0; _nElements = 0; _nAlloc = size; _iEle = 0; _array = new CTextBlock[size]; }
	...
	mov	DWORD PTR $T93765[ebp], eax
	mov	ecx, DWORD PTR $T93765[ebp]
	imul	ecx, 144				; 00000090H
	add	ecx, 4
	push	ecx
	call	??_U@YAPAXI@Z				; operator new[]
	add	esp, 4
	mov	DWORD PTR $T93767[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T93767[ebp], 0
	je	SHORT $L93768
	mov	edx, DWORD PTR $T93767[ebp]
	mov	eax, DWORD PTR $T93765[ebp]
...
$L93769:
	...
	mov	DWORD PTR $T93766[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T93766[ebp]
...
; 44   :     ~CTextBlockAry() { delete[] _array; _array = NULL;}
	...
	mov	DWORD PTR $T93807[ebp], ecx
	mov	edx, DWORD PTR $T93807[ebp]
	mov	DWORD PTR $T93806[ebp], edx
	cmp	DWORD PTR $T93806[ebp], 0
	je	SHORT $L93808
	push	3
	mov	ecx, DWORD PTR $T93806[ebp]
...
PUBLIC	??_C@_0GN@DMEHEIJB@select?5?$CK?5from?5AspectText?5where?5P@ ; `string'
...
EXTRN	_memset:NEAR
EXTRN	?GetIDParts@CTextBlock@@QAEHPAD00@Z:NEAR	; CTextBlock::GetIDParts
EXTRN	__strupr:NEAR
EXTRN	_stricmp:NEAR
...
; File c:\astrow32dev\tbt32\importasptext.cpp
xdata$x	SEGMENT
__unwindtable$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z DD 0ffffffffH
	DD	00H
	DD	00H
	DD	FLAT:__unwindfunclet$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$2
	DD	01H
	DD	FLAT:__unwindfunclet$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$3
	DD	0ffffffffH
	DD	00H
__catchsym$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$4 DD 00H
	DD	FLAT:??_R0PAVCDaoException@@@8
	DD	0fffffc74H
	DD	FLAT:__catch$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$0
__tryblocktable$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z DD 00H
	DD	02H
	DD	03H
	DD	01H
	DD	FLAT:__catchsym$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$4
__ehfuncinfo$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z DD 019930520H
	DD	04H
	DD	FLAT:__unwindtable$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z
	DD	01H
	DD	FLAT:__tryblocktable$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z
	DD	2 DUP(00H)
xdata$x	ENDS
;	COMDAT ??_C@_09FCLAEGGP@?$EA?$EACOMMENT?$AA@
CONST	SEGMENT
...
;	COMDAT ??_C@_0GN@DMEHEIJB@select?5?$CK?5from?5AspectText?5where?5P@
CONST	SEGMENT
??_C@_0GN@DMEHEIJB@select?5?$CK?5from?5AspectText?5where?5P@ DB 'select *'
	DB	' from AspectText where Planet1=''%s'' and Planet2=''%s'' and '
	DB	'Aspect=''%s'' and TextType=''%s'' and Lang=''%s''', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@MNAIMFAK@Can?8t?5Find?5Symbol?5?$CFs?$AA@
CONST	SEGMENT
...
$T93817 = -1112						; size = 4
_e$93570 = -908						; size = 4
_pSym$93565 = -896					; size = 4
_pSym$93559 = -884					; size = 4
_Lang$93552 = -872					; size = 4
_alang$ = -860						; size = 11
_sqlbuf$ = -840						; size = 150
_id3$ = -680						; size = 25
_id2$ = -644						; size = 25
_id$ = -608						; size = 25
_buf$ = -572						; size = 25
...
__$ReturnAddr$ = 4					; size = 4
_pBlk$ = 8						; size = 4
?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z PROC NEAR ; ImportAspText::ProcessItem, COMDAT
; _this$ = ecx
...
; 67   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z
	mov	eax, DWORD PTR fs:__except_list
	push	eax
	mov	DWORD PTR fs:__except_list, esp
	push	ecx
...
; 68   :  TCHAR errbuf[500];
; 69   :  char buf[25], id[25], id2[25], id3[25], sqlbuf[150], alang[11];
...
; 71   :  pBlk->GetIDParts(id, id2, id3);

	lea	eax, DWORD PTR _id3$[ebp]
	push	eax
	lea	ecx, DWORD PTR _id2$[ebp]
	push	ecx
	lea	edx, DWORD PTR _id$[ebp]
	push	edx
	mov	ecx, DWORD PTR _pBlk$[ebp]
	call	?GetIDParts@CTextBlock@@QAEHPAD00@Z	; CTextBlock::GetIDParts

; 72   :  m_pProg->IncProgress();

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+192]
	call	?IncProgress@CProgress@@QAEXXZ		; CProgress::IncProgress

; 73   :  if ( !stricmp(id,"@@COMMENT") )
...
; 76   :    CString Lang = GetCurLanguage();
	...
	push	eax
	lea	ecx, DWORD PTR _Lang$93552[ebp]
...
; 82   : #endif
; 83   :    sprintf( sqlbuf, "select * from AspectText where Planet1='%s' and Planet2='%s' and Aspect='%s' and TextType='%s' and Lang='%s'",
; 84   :      id, id2, id3, buf, alang );

	lea	eax, DWORD PTR _alang$[ebp]
	push	eax
	lea	ecx, DWORD PTR _buf$[ebp]
	push	ecx
	lea	edx, DWORD PTR _id3$[ebp]
	push	edx
	lea	eax, DWORD PTR _id2$[ebp]
	push	eax
	lea	ecx, DWORD PTR _id$[ebp]
	push	ecx
	push	OFFSET FLAT:??_C@_0GN@DMEHEIJB@select?5?$CK?5from?5AspectText?5where?5P@
...
; 97   :    CSymbol *pSym=pRegSymbols->Find(id,1,0);
	...
	mov	DWORD PTR _pSym$93559[ebp], ecx

; 98   :    if ( pSym == NULL ) {

	cmp	DWORD PTR _pSym$93559[ebp], 0
	jne	SHORT $L93560

; 99   : 	   alert_box("Bad Symbol", "Can't Find Symbol %s", id );
...
; 100  :        return( 0 );
	...
	mov	DWORD PTR $T93814[ebp], 0
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR _Lang$93552[ebp]
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	eax, DWORD PTR $T93814[ebp]
	jmp	$L93541
$L93560:

; 101  : 		}
; 102  :    set.m_Planet1num=pSym->value();

	mov	ecx, DWORD PTR _pSym$93559[ebp]
...
; 103  :    pSym=pRegSymbols->Find(id2,2,0);
...
; 105  : 	   CSymbol *pSym=pRegSymbols->Find(id2,4,0);
	...
	mov	DWORD PTR _pSym$93565[ebp], ecx

; 106  : 	   if ( pSym == NULL ) {

	cmp	DWORD PTR _pSym$93565[ebp], 0
	jne	SHORT $L93564

; 107  : 		  alert_box("Bad Symbol", "Can't Find Symbol %s", id2 );
...
; 108  : 		  return( 0 );
	...
	mov	DWORD PTR $T93815[ebp], 0
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR _Lang$93552[ebp]
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	eax, DWORD PTR $T93815[ebp]
	jmp	$L93541
$L93564:

; 109  : 		  }
; 110  : 	}
; 111  :    set.m_Planet2num=pSym->value();
...
; 112  :    pSym=pRegSymbols->Find(id3,3,0);
...
; 114  : 	   alert_box("Bad Symbol", "Can't Find Symbol %s", id3 );
...
; 115  :        return( 0 );
	...
	mov	DWORD PTR $T93816[ebp], 0
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR _Lang$93552[ebp]
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	mov	eax, DWORD PTR $T93816[ebp]
	jmp	$L93541
$L93568:

; 116  : 		}
; 117  :    set.m_Aspectnum=pSym->value();
...
; 118  :    pTransformers->ToReplacements(set.m_Text);
...
; 121  :  }
	...
	call	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
	jmp	SHORT $L93818
__catch$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$0:

; 122  :  catch ( CDaoException *e ) {
; 123  :    e->GetErrorMessage(errbuf,499);
	...
	push	eax
	mov	ecx, DWORD PTR _e$93570[ebp]
...
; 124  :    alert_box(_T("Error on Database"), errbuf );
...
; 125  :    return ( 0 );
	...
	jmp	SHORT __tryend$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$1
$L93823:
	mov	eax, DWORD PTR $T93817[ebp]
	jmp	SHORT $L93541
__tryend$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$1:
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$2:
	lea	ecx, DWORD PTR _Lang$93552[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__unwindfunclet$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z$3:
	lea	ecx, DWORD PTR $T93813[ebp]
	jmp	??1?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >::~CStringT<char,StrTraitMFC<char,ATL::ChTraitsCRT<char> > >
__ehhandler$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z:
	mov	eax, OFFSET FLAT:__ehfuncinfo$?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z
	jmp	___CxxFrameHandler
text$x	ENDS
?ProcessItem@ImportAspText@@QAEHPAVCTextBlock@@@Z ENDP	; ImportAspText::ProcessItem
; Function compile flags: /Odt /RTCcsu /ZI
; File c:\astrow32dev\tbt32\textbloc.hpp
;	COMDAT ?text@CTextBlock@@QAEAAV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$93584[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$93584[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
