...
EXTRN	?DDV_MaxChars@@YGXPAVCDataExchange@@ABV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@H@Z:NEAR ; DDV_MaxChars
...
; 28   : 	DDV_MaxChars(pDX, m_langcode, 10);
	...
	mov	ecx, DWORD PTR _pDX$[ebp]
	push	ecx
	call	?DDV_MaxChars@@YGXPAVCDataExchange@@ABV?$CStringT@DV?$StrTraitMFC@DV?$ChTraitsCRT@D@ATL@@@@@ATL@@H@Z ; DDV_MaxChars
...
; 52   : 	   e->GetErrorMessage(errbuf,499);
	...
	push	0
	push	499					; 000001f3H
	lea	eax, DWORD PTR _errbuf$93067[ebp]
	push	eax
	mov	ecx, DWORD PTR _e$93065[ebp]
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$93081[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$93081[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
