...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?SetFile@CProgress@@QAEXAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
_TEXT	ENDS
PUBLIC	?SetFile@CProgress@@QAEXAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@@Z ; CProgress::SetFile
...
_this$ = -8						; size = 4
_s$ = 8							; size = 4
?SetFile@CProgress@@QAEXAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@@Z PROC NEAR ; CProgress::SetFile, COMDAT
; _this$ = ecx
...
; 52   : }
	...
	pop	ebp
	ret	4
?SetFile@CProgress@@QAEXAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@@Z ENDP ; CProgress::SetFile
_TEXT	ENDS
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$92957[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$92957[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
