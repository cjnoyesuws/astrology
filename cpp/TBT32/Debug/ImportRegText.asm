...
__unwindtable$?Process@ImportRegText@@QAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@ImportRegText@@QAEXXZ$0
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@ImportRegText@@QAEXXZ$2
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@ImportRegText@@QAEXXZ$3
...
; 49   :  CTextBlockAry *pAry= new CTextBlockAry(2,500);
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR $T93663[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	cmp	DWORD PTR $T93663[ebp], 0
	je	SHORT $L93664
	push	500					; 000001f4H
	push	2
...
; 51   :     delete pAry;
	...
	mov	DWORD PTR $T93666[ebp], ecx
	cmp	DWORD PTR $T93666[ebp], 0
	je	SHORT $L93668
	push	1
...
; 61   :  delete pAry;
	...
	mov	eax, DWORD PTR _pAry$[ebp]
	mov	DWORD PTR $T93671[ebp], eax
	mov	ecx, DWORD PTR $T93671[ebp]
	mov	DWORD PTR $T93670[ebp], ecx
	cmp	DWORD PTR $T93670[ebp], 0
	je	SHORT $L93672
	push	1
	mov	ecx, DWORD PTR $T93670[ebp]
	call	??_GCTextBlockAry@@QAEPAXI@Z
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?Process@ImportRegText@@QAEXXZ$0:
	lea	ecx, DWORD PTR $T93659[ebp]
...
__unwindfunclet$?Process@ImportRegText@@QAEXXZ$2:
	lea	ecx, DWORD PTR $T93661[ebp]
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__unwindfunclet$?Process@ImportRegText@@QAEXXZ$3:
	mov	eax, DWORD PTR ?__LINE__Var@?1??Process@ImportRegText@@QAEXXZ@4JA
	add	eax, 19					; 00000013H
	push	eax
	push	OFFSET FLAT:_THIS_FILE
...
; 43   : 	CTextBlockAry(int tp, int size) { _type = tp; _bDirty = 0; _nElements = 0; _nAlloc = size; _iEle = 0; _array = new CTextBlock[size]; }
	...
	mov	DWORD PTR $T93697[ebp], eax
	mov	ecx, DWORD PTR $T93697[ebp]
	imul	ecx, 144				; 00000090H
	add	ecx, 4
	push	ecx
	call	??_U@YAPAXI@Z				; operator new[]
	add	esp, 4
	mov	DWORD PTR $T93699[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T93699[ebp], 0
	je	SHORT $L93700
	mov	edx, DWORD PTR $T93699[ebp]
	mov	eax, DWORD PTR $T93697[ebp]
...
$L93701:
	...
	mov	DWORD PTR $T93698[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T93698[ebp]
...
; 44   :     ~CTextBlockAry() { delete[] _array; _array = NULL;}
	...
	mov	DWORD PTR $T93721[ebp], ecx
	mov	edx, DWORD PTR $T93721[ebp]
	mov	DWORD PTR $T93720[ebp], edx
	cmp	DWORD PTR $T93720[ebp], 0
	je	SHORT $L93722
	push	3
	mov	ecx, DWORD PTR $T93720[ebp]
...
$T93729 = -1552						; size = 4
$T93730 = -1540						; size = 4
_e$93501 = -1336					; size = 4
_pSym$93494 = -1324					; size = 4
_Lang$93487 = -1312					; size = 4
_alang$ = -1300						; size = 11
_sqlbuf$ = -1280					; size = 125
_id2$ = -1144						; size = 25
_id$ = -1108						; size = 25
_buf$ = -1072						; size = 25
...
; 76   :    CString Lang = GetCurLanguage();
	...
	push	eax
	lea	ecx, DWORD PTR _Lang$93487[ebp]
...
; 80   :    sprintf( sqlbuf, "select * from RegularText where Key1='%s' and Key2='%s' and TextType='%s' and Lang='%s'",
; 81   : #else
; 82   :    sprintf( sqlbuf, "select * from RegularText where Key1='%s' and Key2='%s' and TextType='%s'",
; 83   : #endif
; 84   :       id, id2, buf, alang );
...
; 96   :    CSymbol *pSym=pRegSymbols->Find(id,1,0);
	...
	mov	DWORD PTR _pSym$93494[ebp], ecx

; 97   :    if ( pSym == NULL ) {

	cmp	DWORD PTR _pSym$93494[ebp], 0
	jne	SHORT $L93495
...
; 99   :        return( 0 );
	...
	mov	DWORD PTR $T93728[ebp], 0
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR _Lang$93487[ebp]
	call	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
	mov	eax, DWORD PTR $T93728[ebp]
	jmp	$L93477
$L93495:
...
; 101  :    set.m_Key1num=pSym->value();
	...
	mov	ecx, DWORD PTR _pSym$93494[ebp]
...
; 105  :        return( 0 );
	...
	mov	DWORD PTR $T93729[ebp], 0
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR _Lang$93487[ebp]
	call	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
	mov	eax, DWORD PTR $T93729[ebp]
	jmp	$L93477
$L93499:
...
; 113  :    e->GetErrorMessage(errbuf,499);
	...
	push	eax
	mov	ecx, DWORD PTR _e$93501[ebp]
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$93515[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$93515[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
