...
; 13   : IMPLEMENT_DYNCREATE(CTabctrlctrl1, CWnd)
	...
	mov	DWORD PTR $T92995[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T92995[ebp], 0
	je	SHORT $L92996
	mov	ecx, DWORD PTR $T92995[ebp]
...
$L92997:
	...
	mov	DWORD PTR $T92994[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	eax, DWORD PTR $T92994[ebp]
