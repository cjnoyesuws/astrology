...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BI@HFBKDAEG@?$AA?$CF?$AAd?$AA?$HM?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BC@KFLBHEPO@?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BL@MMAJDJCB@pszBuffer?$FLnNewLength?$FN?5?$DN?$DN?50?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Load@CStrTransform@@QAEHPAG@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
_DATA	ENDS
PUBLIC	?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z ; CStrTransform::ToReplacements
...
EXTRN	?GetAt@CStringArray@@QBEABV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@H@Z:NEAR ; CStringArray::GetAt
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z$1
__ehfuncinfo$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z DD 019930520H
	DD	02H
	DD	FLAT:__unwindtable$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT ?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
_TEXT	SEGMENT
_rep$92949 = -56					; size = 4
_sym$92948 = -44					; size = 4
_i$92944 = -32						; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
_str$ = 8						; size = 4
?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z PROC NEAR ; CStrTransform::ToReplacements, COMDAT
; _this$ = ecx
...
; 27   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
...
; 28   :    for ( int i = 0; i < count; i++ ) {
	...
	mov	DWORD PTR _i$92944[ebp], 0
	jmp	SHORT $L92945
$L92946:
	mov	eax, DWORD PTR _i$92944[ebp]
	add	eax, 1
	mov	DWORD PTR _i$92944[ebp], eax
$L92945:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _i$92944[ebp]
...
; 29   :       CString sym=Symbols.GetAt(i);
	...
	call	?GetAt@CStringArray@@QBEABV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@H@Z ; CStringArray::GetAt
	push	eax
	lea	ecx, DWORD PTR _sym$92948[ebp]
...
; 30   :       CString rep=Replacements.GetAt(i);
	...
	call	?GetAt@CStringArray@@QBEABV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@H@Z ; CStringArray::GetAt
	push	eax
	lea	ecx, DWORD PTR _rep$92949[ebp]
	call	??0?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@ABV01@@Z ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z$0:
	lea	ecx, DWORD PTR _sym$92948[ebp]
...
__unwindfunclet$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z$1:
	lea	ecx, DWORD PTR _rep$92949[ebp]
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__ehhandler$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z:
	mov	eax, OFFSET FLAT:__ehfuncinfo$?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
	jmp	___CxxFrameHandler
text$x	ENDS
?ToReplacements@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z ENDP ; CStrTransform::ToReplacements
PUBLIC	?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z ; CStrTransform::ToSymbols
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z$1
__ehfuncinfo$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z DD 019930520H
	DD	02H
	DD	FLAT:__unwindtable$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
; Function compile flags: /Odt /RTCcsu /ZI
xdata$x	ENDS
;	COMDAT ?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
_TEXT	SEGMENT
_rep$92961 = -56					; size = 4
_sym$92960 = -44					; size = 4
_i$92956 = -32						; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
_str$ = 8						; size = 4
?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z PROC NEAR ; CStrTransform::ToSymbols, COMDAT
; _this$ = ecx
...
; 37   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
	mov	eax, DWORD PTR fs:__except_list
	push	eax
	mov	DWORD PTR fs:__except_list, esp
	sub	esp, 240				; 000000f0H
...
; 38   :    for ( int i = 0; i < count; i++ ) {
	...
	mov	DWORD PTR _i$92956[ebp], 0
	jmp	SHORT $L92957
$L92958:
	mov	eax, DWORD PTR _i$92956[ebp]
	add	eax, 1
	mov	DWORD PTR _i$92956[ebp], eax
$L92957:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _i$92956[ebp]
	cmp	ecx, DWORD PTR [eax+44]
	jge	SHORT $L92959
...
; 39   :       CString sym=Symbols.GetAt(i);
	...
	call	?GetAt@CStringArray@@QBEABV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@H@Z ; CStringArray::GetAt
	push	eax
	lea	ecx, DWORD PTR _sym$92960[ebp]
	call	??0?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@ABV01@@Z ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 40   :       CString rep=Replacements.GetAt(i);
	...
	call	?GetAt@CStringArray@@QBEABV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@H@Z ; CStringArray::GetAt
	push	eax
	lea	ecx, DWORD PTR _rep$92961[ebp]
	call	??0?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@ABV01@@Z ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
	mov	BYTE PTR __$EHRec$[ebp+8], 1
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z$0:
	lea	ecx, DWORD PTR _sym$92960[ebp]
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__unwindfunclet$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z$1:
	lea	ecx, DWORD PTR _rep$92961[ebp]
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__ehhandler$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z:
	mov	eax, OFFSET FLAT:__ehfuncinfo$?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z
	jmp	___CxxFrameHandler
text$x	ENDS
?ToSymbols@CStrTransform@@QAEAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@AAV23@@Z ENDP ; CStrTransform::ToSymbols
PUBLIC	?Load@CStrTransform@@QAEHPAG@Z			; CStrTransform::Load
PUBLIC	??_C@_15OMIKMFFN@?$AAr?$AAt?$AA?$AA@		; `string'
PUBLIC	??_C@_1BI@HFBKDAEG@?$AA?$CF?$AAd?$AA?$HM?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@ ; `string'
PUBLIC	??_C@_1BC@KFLBHEPO@?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@ ; `string'
EXTRN	_fwscanf:NEAR
EXTRN	__wfopen:NEAR
EXTRN	_fclose:NEAR
EXTRN	?do_error@@YAXPBG@Z:NEAR			; do_error
EXTRN	?SetAtGrow@CStringArray@@QAEXHPBG@Z:NEAR	; CStringArray::SetAtGrow
...
;	COMDAT ??_C@_1BI@HFBKDAEG@?$AA?$CF?$AAd?$AA?$HM?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@
CONST	SEGMENT
??_C@_1BI@HFBKDAEG@?$AA?$CF?$AAd?$AA?$HM?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@ DB '%'
	DB	00H, 'd', 00H, '|', 00H, '%', 00H, 'l', 00H, '[', 00H, '^', 00H
	DB	0aH, 00H, ']', 00H, '%', 00H, 'c', 00H, 00H, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_1BC@KFLBHEPO@?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@
CONST	SEGMENT
??_C@_1BC@KFLBHEPO@?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@ DB '%'
	DB	00H, 'l', 00H, '[', 00H, '^', 00H, 0aH, 00H, ']', 00H, '%', 00H
...
_name$ = 8						; size = 4
?Load@CStrTransform@@QAEHPAG@Z PROC NEAR		; CStrTransform::Load, COMDAT
; _this$ = ecx
...
; 52   :  stream=_tfopen(name,_T("rt"));
	...
	push	OFFSET FLAT:??_C@_15OMIKMFFN@?$AAr?$AAt?$AA?$AA@
...
; 54   :     do_error( name );
	...
	mov	eax, DWORD PTR _name$[ebp]
	push	eax
	call	?do_error@@YAXPBG@Z			; do_error
	add	esp, 4
...
; 59   : 	_ftscanf(stream,_T("%d|%l[^\n]%c"), &num, str, &dummy );
	...
	push	edx
	push	OFFSET FLAT:??_C@_1BI@HFBKDAEG@?$AA?$CF?$AAd?$AA?$HM?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@
...
; 60   :     _ftscanf(stream,_T("%l[^\n]%c"),rep, &dummy );
	...
	push	ecx
	push	OFFSET FLAT:??_C@_1BC@KFLBHEPO@?$AA?$CF?$AAl?$AA?$FL?$AA?$FO?$AA?6?$AA?$FN?$AA?$CF?$AAc?$AA?$AA@
...
; 65   :     Symbols.SetAtGrow(num-1,str);
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAtGrow@CStringArray@@QAEXHPBG@Z	; CStringArray::SetAtGrow
...
$L93113:
	...
	DB	114					; 00000072H
	DB	0
?Load@CStrTransform@@QAEHPAG@Z ENDP			; CStrTransform::Load
_TEXT	ENDS
...
_TEXT	SEGMENT
tv129 = -364						; size = 4
_nBalance$93008 = -164					; size = 4
_pszTarget$93004 = -152					; size = 4
_pszEnd$93000 = -140					; size = 4
_pszStart$92999 = -128					; size = 4
_pszBuffer$92998 = -116					; size = 4
_nNewLength$92997 = -104				; size = 4
_nOldLength$92996 = -92					; size = 4
_pszTarget$92991 = -80					; size = 4
_pszEnd$92987 = -68					; size = 4
_pszStart$92986 = -56					; size = 4
_nCount$ = -44						; size = 4
...
; 1243 : 			PCXSTR pszStart = GetString();
	...
	mov	DWORD PTR _pszStart$92986[ebp], eax
...
; 1244 : 			PCXSTR pszEnd = pszStart+GetLength();
	...
	mov	ecx, DWORD PTR _pszStart$92986[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	DWORD PTR _pszEnd$92987[ebp], edx
$L92989:

; 1245 : 			while( pszStart < pszEnd )

	mov	eax, DWORD PTR _pszStart$92986[ebp]
	cmp	eax, DWORD PTR _pszEnd$92987[ebp]
	jae	SHORT $L92990
$L92993:
...
; 1248 : 				while( (pszTarget = StringTraits::StringFindString( pszStart, pszOld ) ) != NULL)
	...
	add	esp, 8
	mov	DWORD PTR _pszTarget$92991[ebp], eax
	cmp	DWORD PTR _pszTarget$92991[ebp], 0
	je	SHORT $L92994
...
; 1251 : 					pszStart = pszTarget+nSourceLen;
	...
	mov	ecx, DWORD PTR _pszTarget$92991[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	DWORD PTR _pszStart$92986[ebp], edx
...
; 1262 : 			int nOldLength = GetLength();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetLength@?$CSimpleStringT@G$0A@@ATL@@QBEHXZ ; ATL::CSimpleStringT<unsigned short,0>::GetLength
	mov	DWORD PTR _nOldLength$92996[ebp], eax
...
; 1263 : 			int nNewLength = nOldLength+(nReplacementLen-nSourceLen)*nCount;
	...
	add	eax, DWORD PTR _nOldLength$92996[ebp]
	mov	DWORD PTR _nNewLength$92997[ebp], eax

; 1264 : 
; 1265 : 			PXSTR pszBuffer = GetBuffer( max( nNewLength, nOldLength ) );

	mov	eax, DWORD PTR _nNewLength$92997[ebp]
	cmp	eax, DWORD PTR _nOldLength$92996[ebp]
	jle	SHORT $L93124
	mov	ecx, DWORD PTR _nNewLength$92997[ebp]
	mov	DWORD PTR tv129[ebp], ecx
	jmp	SHORT $L93125
$L93124:
	mov	edx, DWORD PTR _nOldLength$92996[ebp]
...
$L93125:
	...
	mov	DWORD PTR _pszBuffer$92998[ebp], eax

; 1266 : 
; 1267 : 			PXSTR pszStart = pszBuffer;

	mov	eax, DWORD PTR _pszBuffer$92998[ebp]
	mov	DWORD PTR _pszStart$92999[ebp], eax

; 1268 : 			PXSTR pszEnd = pszStart+nOldLength;

	mov	eax, DWORD PTR _nOldLength$92996[ebp]
	mov	ecx, DWORD PTR _pszStart$92999[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	DWORD PTR _pszEnd$93000[ebp], edx
$L93002:
...
; 1271 : 			while( pszStart < pszEnd )
	...
	mov	eax, DWORD PTR _pszStart$92999[ebp]
	cmp	eax, DWORD PTR _pszEnd$93000[ebp]
	jae	$L93003
$L93006:
...
; 1274 : 				while( (pszTarget = StringTraits::StringFindString( pszStart, pszOld ) ) != NULL )
	...
	add	esp, 8
	mov	DWORD PTR _pszTarget$93004[ebp], eax
	cmp	DWORD PTR _pszTarget$93004[ebp], 0
	je	$L93007

; 1275 : 				{
; 1276 : 					int nBalance = nOldLength-int(pszTarget-pszBuffer+nSourceLen);

	mov	eax, DWORD PTR _pszTarget$93004[ebp]
	sub	eax, DWORD PTR _pszBuffer$92998[ebp]
	sar	eax, 1
	add	eax, DWORD PTR _nSourceLen$[ebp]
	mov	ecx, DWORD PTR _nOldLength$92996[ebp]
	sub	ecx, eax
	mov	DWORD PTR _nBalance$93008[ebp], ecx

; 1277 : 					memmove( pszTarget+nReplacementLen, pszTarget+nSourceLen, nBalance*sizeof( XCHAR ) );

	mov	eax, DWORD PTR _nBalance$93008[ebp]
	shl	eax, 1
	push	eax
	mov	ecx, DWORD PTR _nSourceLen$[ebp]
	mov	edx, DWORD PTR _pszTarget$93004[ebp]
...
; 1280 : 					pszStart = pszTarget+nReplacementLen;
	...
	mov	eax, DWORD PTR _nReplacementLen$[ebp]
	mov	ecx, DWORD PTR _pszTarget$93004[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	DWORD PTR _pszStart$92999[ebp], edx

; 1281 : 					pszTarget[nReplacementLen+nBalance] = 0;

	mov	eax, DWORD PTR _nReplacementLen$[ebp]
	add	eax, DWORD PTR _nBalance$93008[ebp]
	mov	ecx, DWORD PTR _pszTarget$93004[ebp]
...
; 1286 : 			ATLASSERT( pszBuffer[nNewLength] == 0 );
	...
	mov	eax, DWORD PTR _nNewLength$92997[ebp]
	mov	ecx, DWORD PTR _pszBuffer$92998[ebp]
