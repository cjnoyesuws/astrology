...
__unwindtable$?Process@ImportAspText@@QAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@ImportAspText@@QAEXXZ$0
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@ImportAspText@@QAEXXZ$3
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Process@ImportAspText@@QAEXXZ$4
...
; 49   :  CTextBlockAry *pAry= new CTextBlockAry(3,500);
	...
	cmp	DWORD PTR $T93672[ebp], 0
	je	SHORT $L93673
	push	500					; 000001f4H
	push	3
	mov	ecx, DWORD PTR $T93672[ebp]
...
$L93674:
	...
	mov	DWORD PTR $T93671[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T93671[ebp]
...
; 51   :     delete pAry;
	...
	mov	DWORD PTR $T93676[ebp], eax
	mov	ecx, DWORD PTR $T93676[ebp]
	mov	DWORD PTR $T93675[ebp], ecx
...
; 61   :  delete pAry;
	...
	mov	eax, DWORD PTR _pAry$[ebp]
	mov	DWORD PTR $T93680[ebp], eax
	mov	ecx, DWORD PTR $T93680[ebp]
	mov	DWORD PTR $T93679[ebp], ecx
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?Process@ImportAspText@@QAEXXZ$0:
	lea	ecx, DWORD PTR $T93667[ebp]
...
__unwindfunclet$?Process@ImportAspText@@QAEXXZ$3:
	lea	ecx, DWORD PTR $T93670[ebp]
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__unwindfunclet$?Process@ImportAspText@@QAEXXZ$4:
	mov	eax, DWORD PTR ?__LINE__Var@?1??Process@ImportAspText@@QAEXXZ@4JA
	add	eax, 20					; 00000014H
	push	eax
	push	OFFSET FLAT:_THIS_FILE
...
; 43   : 	CTextBlockAry(int tp, int size) { _type = tp; _bDirty = 0; _nElements = 0; _nAlloc = size; _iEle = 0; _array = new CTextBlock[size]; }
	...
	mov	DWORD PTR $T93707[ebp], eax
	mov	ecx, DWORD PTR $T93707[ebp]
	imul	ecx, 144				; 00000090H
	add	ecx, 4
	push	ecx
	call	??_U@YAPAXI@Z				; operator new[]
	add	esp, 4
	mov	DWORD PTR $T93709[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T93709[ebp], 0
	je	SHORT $L93710
	mov	edx, DWORD PTR $T93709[ebp]
	mov	eax, DWORD PTR $T93707[ebp]
...
; 44   :     ~CTextBlockAry() { delete[] _array; _array = NULL;}
	...
	mov	DWORD PTR $T93730[ebp], edx
	cmp	DWORD PTR $T93730[ebp], 0
	je	SHORT $L93732
	push	3
	mov	ecx, DWORD PTR $T93730[ebp]
...
$T93740 = -1624						; size = 4
$T93741 = -1612						; size = 4
_e$93509 = -1408					; size = 4
_pSym$93504 = -1396					; size = 4
_pSym$93498 = -1384					; size = 4
_Lang$93491 = -1372					; size = 4
_alang$ = -1360						; size = 11
_sqlbuf$ = -1340					; size = 150
_id3$ = -1180						; size = 25
_id2$ = -1144						; size = 25
_id$ = -1108						; size = 25
_buf$ = -1072						; size = 25
...
; 67   : {
	...
	mov	DWORD PTR fs:__except_list, esp
	push	ecx
	sub	esp, 1656				; 00000678H
	push	ebx
	push	esi
	push	edi
	push	ecx
	lea	edi, DWORD PTR [ebp-1672]
...
; 76   :    CString Lang = GetCurLanguage();
	...
	push	eax
	lea	ecx, DWORD PTR _Lang$93491[ebp]
...
; 80   :    sprintf( sqlbuf, "select * from AspectText where Planet1='%s' and Planet2='%s' and Aspect='%s' and TextType='%s' and Lang='%s'",
; 81   : #else
; 82   :    sprintf( sqlbuf, "select * from AspectText where Planet1='%s' and Planet2='%s' and Aspect='%s' and TextType='%s'",
; 83   : #endif
...
; 97   :    CSymbol *pSym=pRegSymbols->Find(id,1,0);
	...
	mov	DWORD PTR _pSym$93498[ebp], ecx

; 98   :    if ( pSym == NULL ) {

	cmp	DWORD PTR _pSym$93498[ebp], 0
	jne	SHORT $L93499
...
; 102  :    set.m_Planet1num=pSym->value();
	...
	mov	ecx, DWORD PTR _pSym$93498[ebp]
...
; 105  : 	   CSymbol *pSym=pRegSymbols->Find(id2,4,0);
	...
	mov	DWORD PTR _pSym$93504[ebp], ecx

; 106  : 	   if ( pSym == NULL ) {

	cmp	DWORD PTR _pSym$93504[ebp], 0
	jne	SHORT $L93503
...
; 108  : 		  return( 0 );
	...
	mov	DWORD PTR $T93739[ebp], 0
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR _Lang$93491[ebp]
	call	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
	mov	eax, DWORD PTR $T93739[ebp]
	jmp	$L93480
$L93503:
...
; 123  :    e->GetErrorMessage(errbuf,499);
	...
	push	eax
	mov	ecx, DWORD PTR _e$93509[ebp]
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$93523[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$93523[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
