...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BI@BCNBDDPP@?$AA?$FL?$AAL?$AAa?$AAn?$AAg?$AAu?$AAa?$AAg?$AAe?$AAs?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BG@PKPDEHIJ@?$AA?$FL?$AAl?$AAa?$AAn?$AAg?$AAc?$AAo?$AAd?$AAe?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BM@EAEPEFHF@?$AA?$FL?$AAD?$AAe?$AAs?$AAc?$AAr?$AAi?$AAp?$AAt?$AAi?$AAo?$AAn?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDefaultDBName@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDefaultSQL@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
PUBLIC	?GetDefaultDBName@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ; CDLanguages::GetDefaultDBName
PUBLIC	?GetDefaultSQL@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ; CDLanguages::GetDefaultSQL
...
??_7CDLanguages@@6B@ DD FLAT:?GetRuntimeClass@CDLanguages@@UBEPAUCRuntimeClass@@XZ ; CDLanguages::`vftable'
	...
	DD	FLAT:?GetDefaultDBName@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
	DD	FLAT:?GetDefaultSQL@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
...
?GetDefaultDBName@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ PROC NEAR ; CDLanguages::GetDefaultDBName, COMDAT
; _this$ = ecx
...
; 34   : 	return GetDatabaseNamePath();
	...
	add	esp, 4
	mov	ecx, DWORD PTR $T93097[ebp]
	or	ecx, 1
	mov	DWORD PTR $T93097[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 35   : }
	...
	pop	ebp
	ret	4
?GetDefaultDBName@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ENDP ; CDLanguages::GetDefaultDBName
_TEXT	ENDS
PUBLIC	??_C@_1BI@BCNBDDPP@?$AA?$FL?$AAL?$AAa?$AAn?$AAg?$AAu?$AAa?$AAg?$AAe?$AAs?$AA?$FN?$AA?$AA@ ; `string'
...
;	COMDAT ??_C@_1BI@BCNBDDPP@?$AA?$FL?$AAL?$AAa?$AAn?$AAg?$AAu?$AAa?$AAg?$AAe?$AAs?$AA?$FN?$AA?$AA@
CONST	SEGMENT
??_C@_1BI@BCNBDDPP@?$AA?$FL?$AAL?$AAa?$AAn?$AAg?$AAu?$AAa?$AAg?$AAe?$AAs?$AA?$FN?$AA?$AA@ DB '['
	DB	00H, 'L', 00H, 'a', 00H, 'n', 00H, 'g', 00H, 'u', 00H, 'a', 00H
	DB	'g', 00H, 'e', 00H, 's', 00H, ']', 00H, 00H, 00H ; `string'
; Function compile flags: /Odt /RTCcsu /ZI
CONST	ENDS
;	COMDAT ?GetDefaultSQL@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT
...
_this$ = -8						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetDefaultSQL@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ PROC NEAR ; CDLanguages::GetDefaultSQL, COMDAT
; _this$ = ecx
...
; 38   : {
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T93102[ebp], 0

; 39   : 	return _T("[Languages]");

	push	OFFSET FLAT:??_C@_1BI@BCNBDDPP@?$AA?$FL?$AAL?$AAa?$AAn?$AAg?$AAu?$AAa?$AAg?$AAe?$AAs?$AA?$FN?$AA?$AA@
	...
	mov	eax, DWORD PTR $T93102[ebp]
	or	eax, 1
	mov	DWORD PTR $T93102[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 40   : }
	...
	pop	ebp
	ret	4
?GetDefaultSQL@CDLanguages@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ENDP ; CDLanguages::GetDefaultSQL
_TEXT	ENDS
PUBLIC	??_C@_1BG@PKPDEHIJ@?$AA?$FL?$AAl?$AAa?$AAn?$AAg?$AAc?$AAo?$AAd?$AAe?$AA?$FN?$AA?$AA@ ; `string'
PUBLIC	??_C@_1BM@EAEPEFHF@?$AA?$FL?$AAD?$AAe?$AAs?$AAc?$AAr?$AAi?$AAp?$AAt?$AAi?$AAo?$AAn?$AA?$FN?$AA?$AA@ ; `string'
...
;	COMDAT ??_C@_1BG@PKPDEHIJ@?$AA?$FL?$AAl?$AAa?$AAn?$AAg?$AAc?$AAo?$AAd?$AAe?$AA?$FN?$AA?$AA@
CONST	SEGMENT
??_C@_1BG@PKPDEHIJ@?$AA?$FL?$AAl?$AAa?$AAn?$AAg?$AAc?$AAo?$AAd?$AAe?$AA?$FN?$AA?$AA@ DB '['
	DB	00H, 'l', 00H, 'a', 00H, 'n', 00H, 'g', 00H, 'c', 00H, 'o', 00H
	DB	'd', 00H, 'e', 00H, ']', 00H, 00H, 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_1BM@EAEPEFHF@?$AA?$FL?$AAD?$AAe?$AAs?$AAc?$AAr?$AAi?$AAp?$AAt?$AAi?$AAo?$AAn?$AA?$FN?$AA?$AA@
CONST	SEGMENT
??_C@_1BM@EAEPEFHF@?$AA?$FL?$AAD?$AAe?$AAs?$AAc?$AAr?$AAi?$AAp?$AAt?$AAi?$AAo?$AAn?$AA?$FN?$AA?$AA@ DB '['
	DB	00H, 'D', 00H, 'e', 00H, 's', 00H, 'c', 00H, 'r', 00H, 'i', 00H
...
; 46   : 	DFX_Text(pFX, _T("[langcode]"), m_langcode);
	...
	push	eax
	push	OFFSET FLAT:??_C@_1BG@PKPDEHIJ@?$AA?$FL?$AAl?$AAa?$AAn?$AAg?$AAc?$AAo?$AAd?$AAe?$AA?$FN?$AA?$AA@
	mov	ecx, DWORD PTR _pFX$[ebp]
	push	ecx
...
; 47   : 	DFX_Text(pFX, _T("[Description]"), m_Description);
	...
	push	eax
	push	OFFSET FLAT:??_C@_1BM@EAEPEFHF@?$AA?$FL?$AAD?$AAe?$AAs?$AAc?$AAr?$AAi?$AAp?$AAt?$AAi?$AAo?$AAn?$AA?$FN?$AA?$AA@
	mov	ecx, DWORD PTR _pFX$[ebp]
	push	ecx
	call	?DFX_Text@@YGXPAVCDaoFieldExchange@@PBGAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@HK@Z ; DFX_Text
