...
_TLS	ENDS
;	COMDAT ??_C@_09BIFGFIEM@CDregText?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BM@DHLNBLMH@?$AA?$FL?$AAR?$AAe?$AAg?$AAu?$AAl?$AAa?$AAr?$AAT?$AAe?$AAx?$AAt?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BG@ILCPOCCL@?$AA?$FL?$AAT?$AAe?$AAx?$AAt?$AAT?$AAy?$AAp?$AAe?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1O@HFBGCDEO@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1O@OLLDIKBI@?$AA?$FL?$AAk?$AAe?$AAy?$AA2?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BE@HOACPBAE@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_1BE@JJMCDPE@?$AA?$FL?$AAK?$AAe?$AAy?$AA2?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ?GetRuntimeClass@CDregText@@UBEPAUCRuntimeClass@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??0CDregText@@QAE@PAVCDaoDatabase@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??_GCDregText@@UAEPAXI@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??1CDregText@@UAE@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDefaultDBName@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDefaultSQL@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?DoFieldExchange@CDregText@@UAEXPAVCDaoFieldExchange@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?AssertValid@CDregText@@UBEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Dump@CDregText@@UBEXAAVCDumpContext@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??_7CDregText@@6B@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ?classCDregText@CDregText@@2UCRuntimeClass@@B
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
PUBLIC	?classCDregText@CDregText@@2UCRuntimeClass@@B	; CDregText::classCDregText
PUBLIC	??_C@_09BIFGFIEM@CDregText?$AA@			; `string'
EXTRN	?classCDaoRecordset@CDaoRecordset@@2UCRuntimeClass@@B:BYTE ; CDaoRecordset::classCDaoRecordset
_DATA	SEGMENT
_THIS_FILE DB	'c:\astrow32dev\tbt32\dregtext1.cpp', 00H
_DATA	ENDS
;	COMDAT ??_C@_09BIFGFIEM@CDregText?$AA@
CONST	SEGMENT
??_C@_09BIFGFIEM@CDregText?$AA@ DB 'CDregText', 00H	; `string'
CONST	ENDS
;	COMDAT ?classCDregText@CDregText@@2UCRuntimeClass@@B
CONST	SEGMENT
?classCDregText@CDregText@@2UCRuntimeClass@@B DD FLAT:??_C@_09BIFGFIEM@CDregText?$AA@ ; CDregText::classCDregText
	DD	0b0H
	DD	0ffffH
	DD	00H
	...
	DD	00H
CONST	ENDS
PUBLIC	?GetRuntimeClass@CDregText@@UBEPAUCRuntimeClass@@XZ ; CDregText::GetRuntimeClass
EXTRN	__RTC_InitBase:NEAR
EXTRN	__RTC_Shutdown:NEAR
;	COMDAT rtc$IMZ
; File c:\astrow32dev\tbt32\dregtext1.cpp
rtc$IMZ	SEGMENT
...
_TEXT	SEGMENT
_this$ = -8						; size = 4
?GetRuntimeClass@CDregText@@UBEPAUCRuntimeClass@@XZ PROC NEAR ; CDregText::GetRuntimeClass, COMDAT
; _this$ = ecx

; 19   : IMPLEMENT_DYNAMIC(CDregText, CDaoRecordset)
	...
	mov	eax, OFFSET FLAT:?classCDregText@CDregText@@2UCRuntimeClass@@B ; CDregText::classCDregText
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
?GetRuntimeClass@CDregText@@UBEPAUCRuntimeClass@@XZ ENDP ; CDregText::GetRuntimeClass
_TEXT	ENDS
PUBLIC	??_C@_11LOCGONAA@?$AA?$AA@			; `string'
PUBLIC	??0CDregText@@QAE@PAVCDaoDatabase@@@Z		; CDregText::CDregText
PUBLIC	?GetDefaultDBName@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ; CDregText::GetDefaultDBName
PUBLIC	?GetDefaultSQL@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ; CDregText::GetDefaultSQL
PUBLIC	?DoFieldExchange@CDregText@@UAEXPAVCDaoFieldExchange@@@Z ; CDregText::DoFieldExchange
PUBLIC	?AssertValid@CDregText@@UBEXXZ			; CDregText::AssertValid
PUBLIC	?Dump@CDregText@@UBEXAAVCDumpContext@@@Z	; CDregText::Dump
PUBLIC	??_7CDregText@@6B@				; CDregText::`vftable'
PUBLIC	??_GCDregText@@UAEPAXI@Z			; CDregText::`scalar deleting destructor'
...
EXTRN	??_ECDregText@@UAEPAXI@Z:NEAR			; CDregText::`vector deleting destructor'
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??0CDregText@@QAE@PAVCDaoDatabase@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$1
	DD	01H
	DD	FLAT:__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$2
	DD	02H
	DD	FLAT:__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$3
	DD	03H
	DD	FLAT:__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$4
	DD	04H
	DD	FLAT:__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$5
__ehfuncinfo$??0CDregText@@QAE@PAVCDaoDatabase@@@Z DD 019930520H
	DD	06H
	DD	FLAT:__unwindtable$??0CDregText@@QAE@PAVCDaoDatabase@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
xdata$x	ENDS
;	COMDAT ??_7CDregText@@6B@
CONST	SEGMENT
??_7CDregText@@6B@ DD FLAT:?GetRuntimeClass@CDregText@@UBEPAUCRuntimeClass@@XZ ; CDregText::`vftable'
	DD	FLAT:??_ECDregText@@UAEPAXI@Z
	DD	FLAT:?Serialize@CObject@@UAEXAAVCArchive@@@Z
	DD	FLAT:?AssertValid@CDregText@@UBEXXZ
	DD	FLAT:?Dump@CDregText@@UBEXAAVCDumpContext@@@Z
	...
	DD	FLAT:?GetDefaultDBName@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
	DD	FLAT:?GetDefaultSQL@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
	DD	FLAT:?DoFieldExchange@CDregText@@UAEXPAVCDaoFieldExchange@@@Z
...
__$EHRec$ = -12						; size = 12
_pdb$ = 8						; size = 4
??0CDregText@@QAE@PAVCDaoDatabase@@@Z PROC NEAR		; CDregText::CDregText, COMDAT
; _this$ = ecx
...
; 23   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0CDregText@@QAE@PAVCDaoDatabase@@@Z
	...
	mov	DWORD PTR [eax], OFFSET FLAT:??_7CDregText@@6B@
	mov	ecx, DWORD PTR _this$[ebp]
...
; 33   : 	//}}AFX_FIELD_INIT
; 34   : 	m_nDefaultType = dbOpenDynaset;
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1CDaoRecordset@@UAE@XZ		; CDaoRecordset::~CDaoRecordset
__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$1:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 152				; 00000098H
...
__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$2:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 156				; 0000009cH
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$3:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 160				; 000000a0H
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$4:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 168				; 000000a8H
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__unwindfunclet$??0CDregText@@QAE@PAVCDaoDatabase@@@Z$5:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 172				; 000000acH
	jmp	??1?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@QAE@XZ ; ATL::CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >::~CStringT<unsigned short,StrTraitMFC<unsigned short,ATL::ChTraitsCRT<unsigned short> > >
__ehhandler$??0CDregText@@QAE@PAVCDaoDatabase@@@Z:
	mov	eax, OFFSET FLAT:__ehfuncinfo$??0CDregText@@QAE@PAVCDaoDatabase@@@Z
	jmp	___CxxFrameHandler
text$x	ENDS
??0CDregText@@QAE@PAVCDaoDatabase@@@Z ENDP		; CDregText::CDregText
...
_this$ = -8						; size = 4
___flags$ = 8						; size = 4
??_GCDregText@@UAEPAXI@Z PROC NEAR			; CDregText::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
...
$L92991:
	...
	pop	ebp
	ret	4
??_GCDregText@@UAEPAXI@Z ENDP				; CDregText::`scalar deleting destructor'
; Function compile flags: /Odt /RTCcsu /ZI
_TEXT	ENDS
;	COMDAT ??1CDregText@@UAE@XZ
_TEXT	SEGMENT
...
?GetDefaultDBName@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ PROC NEAR ; CDregText::GetDefaultDBName, COMDAT
; _this$ = ecx
...
; 39   : {
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T93167[ebp], 0

; 40   : 	return GetDatabaseNamePath();

	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	push	eax
	call	?GetDatabaseNamePath@@YA?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ; GetDatabaseNamePath
	add	esp, 4
	mov	ecx, DWORD PTR $T93167[ebp]
	or	ecx, 1
	mov	DWORD PTR $T93167[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 41   : }
	...
	pop	ebp
	ret	4
?GetDefaultDBName@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ENDP ; CDregText::GetDefaultDBName
_TEXT	ENDS
PUBLIC	??_C@_1BM@DHLNBLMH@?$AA?$FL?$AAR?$AAe?$AAg?$AAu?$AAl?$AAa?$AAr?$AAT?$AAe?$AAx?$AAt?$AA?$FN?$AA?$AA@ ; `string'
...
;	COMDAT ??_C@_1BM@DHLNBLMH@?$AA?$FL?$AAR?$AAe?$AAg?$AAu?$AAl?$AAa?$AAr?$AAT?$AAe?$AAx?$AAt?$AA?$FN?$AA?$AA@
CONST	SEGMENT
??_C@_1BM@DHLNBLMH@?$AA?$FL?$AAR?$AAe?$AAg?$AAu?$AAl?$AAa?$AAr?$AAT?$AAe?$AAx?$AAt?$AA?$FN?$AA?$AA@ DB '['
	DB	00H, 'R', 00H, 'e', 00H, 'g', 00H, 'u', 00H, 'l', 00H, 'a', 00H
	DB	'r', 00H, 'T', 00H, 'e', 00H, 'x', 00H, 't', 00H, ']', 00H, 00H
	DB	00H						; `string'
; Function compile flags: /Odt /RTCcsu /ZI
CONST	ENDS
;	COMDAT ?GetDefaultSQL@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ
...
_this$ = -8						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetDefaultSQL@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ PROC NEAR ; CDregText::GetDefaultSQL, COMDAT
; _this$ = ecx
...
; 44   : {
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T93172[ebp], 0

; 45   : 	return _T("[RegularText]");

	push	OFFSET FLAT:??_C@_1BM@DHLNBLMH@?$AA?$FL?$AAR?$AAe?$AAg?$AAu?$AAl?$AAa?$AAr?$AAT?$AAe?$AAx?$AAt?$AA?$FN?$AA?$AA@
	...
	mov	eax, DWORD PTR $T93172[ebp]
	or	eax, 1
	mov	DWORD PTR $T93172[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 46   : }
	...
	pop	ebp
	ret	4
?GetDefaultSQL@CDregText@@UAE?AV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@XZ ENDP ; CDregText::GetDefaultSQL
_TEXT	ENDS
PUBLIC	??_C@_1BG@ILCPOCCL@?$AA?$FL?$AAT?$AAe?$AAx?$AAt?$AAT?$AAy?$AAp?$AAe?$AA?$FN?$AA?$AA@ ; `string'
PUBLIC	??_C@_1O@HFBGCDEO@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AA?$FN?$AA?$AA@ ; `string'
PUBLIC	??_C@_1O@OLLDIKBI@?$AA?$FL?$AAk?$AAe?$AAy?$AA2?$AA?$FN?$AA?$AA@ ; `string'
PUBLIC	??_C@_1BE@HOACPBAE@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@ ; `string'
PUBLIC	??_C@_1BE@JJMCDPE@?$AA?$FL?$AAK?$AAe?$AAy?$AA2?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@ ; `string'
...
;	COMDAT ??_C@_1O@HFBGCDEO@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AA?$FN?$AA?$AA@
CONST	SEGMENT
??_C@_1O@HFBGCDEO@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AA?$FN?$AA?$AA@ DB '[', 00H
	DB	'K', 00H, 'e', 00H, 'y', 00H, '1', 00H, ']', 00H, 00H, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_1O@OLLDIKBI@?$AA?$FL?$AAk?$AAe?$AAy?$AA2?$AA?$FN?$AA?$AA@
CONST	SEGMENT
??_C@_1O@OLLDIKBI@?$AA?$FL?$AAk?$AAe?$AAy?$AA2?$AA?$FN?$AA?$AA@ DB '[', 00H
	DB	'k', 00H, 'e', 00H, 'y', 00H, '2', 00H, ']', 00H, 00H, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_1BE@HOACPBAE@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@
CONST	SEGMENT
??_C@_1BE@HOACPBAE@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@ DB '['
	DB	00H, 'K', 00H, 'e', 00H, 'y', 00H, '1', 00H, 'n', 00H, 'u', 00H
	DB	'm', 00H, ']', 00H, 00H, 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_1BE@JJMCDPE@?$AA?$FL?$AAK?$AAe?$AAy?$AA2?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@
CONST	SEGMENT
??_C@_1BE@JJMCDPE@?$AA?$FL?$AAK?$AAe?$AAy?$AA2?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@ DB '['
	DB	00H, 'K', 00H, 'e', 00H, 'y', 00H, '2', 00H, 'n', 00H, 'u', 00H
	DB	'm', 00H, ']', 00H, 00H, 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_1O@JIKFMKIC@?$AA?$FL?$AAT?$AAe?$AAx?$AAt?$AA?$FN?$AA?$AA@
CONST	SEGMENT
...
_this$ = -8						; size = 4
_pFX$ = 8						; size = 4
?DoFieldExchange@CDregText@@UAEXPAVCDaoFieldExchange@@@Z PROC NEAR ; CDregText::DoFieldExchange, COMDAT
; _this$ = ecx
...
; 50   : 	//{{AFX_FIELD_MAP(CDregText)
; 51   : 	pFX->SetFieldType(CDaoFieldExchange::outputColumn);

	push	1
	mov	ecx, DWORD PTR _pFX$[ebp]
	call	?SetFieldType@CDaoFieldExchange@@QAEXI@Z ; CDaoFieldExchange::SetFieldType

; 52   : 	DFX_Text(pFX, _T("[TextType]"), m_TextType);
...
; 53   : 	DFX_Text(pFX, _T("[Key1]"), m_Key1);
	...
	push	eax
	push	OFFSET FLAT:??_C@_1O@HFBGCDEO@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AA?$FN?$AA?$AA@
	mov	ecx, DWORD PTR _pFX$[ebp]
	push	ecx
	call	?DFX_Text@@YGXPAVCDaoFieldExchange@@PBGAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@HK@Z ; DFX_Text

; 54   : 	DFX_Text(pFX, _T("[key2]"), m_key2);
	...
	push	eax
	push	OFFSET FLAT:??_C@_1O@OLLDIKBI@?$AA?$FL?$AAk?$AAe?$AAy?$AA2?$AA?$FN?$AA?$AA@
	mov	ecx, DWORD PTR _pFX$[ebp]
	push	ecx
	call	?DFX_Text@@YGXPAVCDaoFieldExchange@@PBGAAV?$CStringT@GV?$StrTraitMFC@GV?$ChTraitsCRT@G@ATL@@@@@ATL@@HK@Z ; DFX_Text

; 55   : 	DFX_Short(pFX, _T("[Key1num]"), m_Key1num);

	push	1
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 164				; 000000a4H
	push	eax
	push	OFFSET FLAT:??_C@_1BE@HOACPBAE@?$AA?$FL?$AAK?$AAe?$AAy?$AA1?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@
	mov	ecx, DWORD PTR _pFX$[ebp]
	push	ecx
	call	?DFX_Short@@YGXPAVCDaoFieldExchange@@PBGAAFK@Z ; DFX_Short

; 56   : 	DFX_Short(pFX, _T("[Key2num]"), m_Key2num);

	push	1
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 166				; 000000a6H
	push	eax
	push	OFFSET FLAT:??_C@_1BE@JJMCDPE@?$AA?$FL?$AAK?$AAe?$AAy?$AA2?$AAn?$AAu?$AAm?$AA?$FN?$AA?$AA@
	mov	ecx, DWORD PTR _pFX$[ebp]
	push	ecx
	call	?DFX_Short@@YGXPAVCDaoFieldExchange@@PBGAAFK@Z ; DFX_Short

; 57   : 	DFX_Text(pFX, _T("[Text]"), m_Text);
...
; 59   : 	DFX_Text(pFX, _T("[Lang]"), m_Lang);
...
; 61   : }
	...
	pop	ebp
	ret	4
?DoFieldExchange@CDregText@@UAEXPAVCDaoFieldExchange@@@Z ENDP ; CDregText::DoFieldExchange
_TEXT	ENDS
...
_TEXT	SEGMENT
_this$ = -8						; size = 4
?AssertValid@CDregText@@UBEXXZ PROC NEAR		; CDregText::AssertValid, COMDAT
; _this$ = ecx
...
; 70   : }
	...
	pop	ebp
	ret	0
?AssertValid@CDregText@@UBEXXZ ENDP			; CDregText::AssertValid
_TEXT	ENDS
...
_this$ = -8						; size = 4
_dc$ = 8						; size = 4
?Dump@CDregText@@UBEXAAVCDumpContext@@@Z PROC NEAR	; CDregText::Dump, COMDAT
; _this$ = ecx
...
; 75   : }
	...
	pop	ebp
	ret	4
?Dump@CDregText@@UBEXAAVCDumpContext@@@Z ENDP		; CDregText::Dump
_TEXT	ENDS
...
; 284  : 				CStringData* pNewData = CloneData( pSrcData );
	...
	add	esp, 4
	mov	DWORD PTR _pNewData$93035[ebp], eax
...
; 286  : 				Attach( pNewData );
	...
	mov	eax, DWORD PTR _pNewData$93035[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
