...
#ifdef _UNICODE
CBatchMgr *pExportedRept = NULL;
CBatchMgr *pExportedReg= NULL;
CBatchMgr *pExportedAsp = NULL;
CBatchMgr *pExportedHlp=NULL;
#endif
/////////////////////////////////////////////////////////////////////////////
// CTBT32App
...
int CTBT32App::ExitInstance() 
{
   ...
   delete pATextTypes;
#ifdef _UNICODE
   if (pExportedRept != NULL )
	   delete pExportedRept;
   if (pExportedReg != NULL )
	   delete pExportedReg;
   if ( pExportedAsp != NULL )
	   delete pExportedAsp;
   if ( pExportedHlp != NULL )
	   delete pExportedHlp;
#endif 
