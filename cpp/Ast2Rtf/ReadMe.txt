========================================================================
    ACTIVE TEMPLATE LIBRARY : Ast2Rtf Project Overview
========================================================================

AppWizard has created this Ast2Rtf project for you to use as the starting point for
...
_Ast2Rtf.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Ast2Rtf.h)
        GUID definitions                                (_Ast2Rtf_i.c)
        A type library                                  (_Ast2Rtf.tlb)
        Marshaling code                                 (_Ast2Rtf_p.c and dlldata.c)
Ast2Rtf.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Ast2Rtf.pch and a precompiled types file named StdAfx.obj.
...
Ast2Rtfps.vcproj
	...
	dlldata.c, Ast2Rtf_i.c and Ast2Rtf_p.c which are required
