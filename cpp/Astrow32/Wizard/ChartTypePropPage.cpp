...
{
 static int ftypes[] = {NATAL_FILE,NATAL_FILE,NATAL_FILE,NATAL_FILE,NATAL_FILE,COMPATIBILITY_FILE,TRANSITS_FILE,
	 PROGRESSED_FILE,RELOCATION_FILE,SOLAR_RETURN_FILE,RETURN_W_RELOC,RETURN_W_TRANS,COMPOSITE_FILE,SOLARARC_FILE,
