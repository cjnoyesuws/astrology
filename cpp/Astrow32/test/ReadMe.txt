...
CntrItem.h, CntrItem.cpp - this class is used to
	...
	CTestView class and serialized as part of your CTestDoc class.

SrvrItem.h, SrvrItem.cpp - this class is used to
	connect your CTestDoc class to the OLE system, and optionally
...
MakeHelp.bat
    Use this batch file to create your application's Help file, test.hLP.
