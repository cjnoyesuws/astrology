...
makehm ID_,HID_,0x10000 IDM_,HIDM_,0x10000 resource.h >>"hlp\Astrow.hm"
echo. >>"hlp\Astrow.hm"
echo // Prompts (IDP_*) >>"hlp\Astrow.hm"
makehm IDP_,HIDP_,0x30000 resource.h >>"hlp\Astrow.hm"
echo. >>"hlp\Astrow.hm"
echo // Resources (IDR_*) >>"hlp\Astrow.hm"
makehm IDR_,HIDR_,0x20000 resource.h >>"hlp\Astrow.hm"
echo. >>"hlp\Astrow.hm"
echo // Dialogs (IDD_*) >>"hlp\Astrow.hm"
makehm IDD_,HIDD_,0x20000 resource.h >>"hlp\Astrow.hm"
echo. >>"hlp\Astrow.hm"
echo // Frame Controls (IDW_*) >>"hlp\Astrow.hm"
makehm IDW_,HIDW_,0x50000 resource.h >>"hlp\Astrow.hm"
