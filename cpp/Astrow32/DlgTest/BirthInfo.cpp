...
{
 COleDateTime tm(year, month, 1, 0, 0, 0 );
 COleDateTimeSpan oneday(1,0,0,0);
 COleDateTimeSpan threeweeks(21,0,0,0);
 while ( tm.GetDayOfWeek() != 1 )
    tm += oneday;
 tm += threeweeks;
 return (tm.GetDay());
}
...
int IsInDaylightSavings( COleDateTime &dt )
{
  if ( dt.GetYear() < 1945 )
	  return 0;
  if ( dt.GetMonth() < 4 || dt.GetMonth() > 10 )
	  return 0;
  int lastday = LastSunday( dt.GetYear(), dt.GetMonth() );
  if ( dt.GetMonth() == 4 && dt.GetDay() < lastday )
	  return 0;
  if ( dt.GetMonth() == 10 && dt.GetDay() > lastday )
	  return 0;
  if ( dt.GetMonth() == 4 && dt.GetDay() == lastday &&
	      dt.GetHour() < 2 )
	  return 0;
...
CBirthInfo::CBirthInfo(CWnd* pParent)
: CDialog(CBirthInfo::IDD, pParent)
{
	//{{AFX_DATA_INIT(CBirthInfo)
	m_country = _T("");
	m_eastwest = -1;
	m_gmthr = 0;
	m_gmtmin = 0;
...
void CBirthInfo::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CBirthInfo)
...
BEGIN_MESSAGE_MAP(CBirthInfo, CDialog)
	//{{AFX_MSG_MAP(CBirthInfo)
...
/////////////////////////////////////////////////////////////////////////////
// CBirthInfo message handlers

void CBirthInfo::OnBimenu() 
{
...
void CBirthInfo::OnSelchangeBiname() 
{
	// TODO: Add your control notification handler code here
	int sel;
	BIRTH_DB db;	
...
void CBirthInfo::OnSelchangeRltimezone() 
{
	// TODO: Add your control notification handler code here
CString txt;
if ( !in_update_data )
...
void CBirthInfo::OnKillfocusRlstate() 
{
	// TODO: Add your control notification handler code here
	int sel;
	long lrec;
...
void CBirthInfo::OnKillfocusRlcountry() 
{
	// TODO: Add your control notification handler code here
	int sel;
	long lrec;
...
BOOL CBirthInfo::OnCommand(WPARAM wParam, LPARAM lParam) 
{
...
void CBirthInfo::OnSelchangeRllocation() 
{
	// TODO: Add your control notification handler code here
	int sel;
	LOC_DB db;
...
void CBirthInfo::SetData( LOC_DB &l )
{
m_country = l.country;
m_state = l.state;
...
void CBirthInfo::GetData( LOC_DB &l )
{
...
void CBirthInfo::OnEditchangeRlcountry() 
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLCOUNTRY);
...
void CBirthInfo::OnSelchangeRlcountry() 
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLCOUNTRY);
int sel = pco->GetCurSel();
...
void CBirthInfo::OnEditchangeRllocation() 
{
	// TODO: Add your control notification handler code here
...
void CBirthInfo::OnSelchangeRlstate() 
{
	// TODO: Add your control notification handler code here
...
void CBirthInfo::OnEditchangeRlstate() 
{
	// TODO: Add your control notification handler code here
CComboBox *pco = (CComboBox *)GetDlgItem(ID_RLSTATE);
int sel = pco->GetCurSel();
...
void CBirthInfo::SetData( BIRTH_DB &b, RECT_DATA &r )
{
rect = r;
m_sex = b.sex;
m_ampm =b.am_pm;
...
void CBirthInfo::GetData( BIRTH_DB &b, RECT_DATA &r )
{
r = rect;
b.sex = m_sex;
adjustTime();
...
void CBirthInfo::OnEditchangeBiname() 
{
	// TODO: Add your control notification handler code here
	int sel;
...
void CBirthInfo::updateCombos()
{

}

void CBirthInfo::OnHelp() 
{
	// TODO: Add your control notification handler code here
	CDialog::WinHelp(LOWORD((DWORD)IDD)+HID_BASE_RESOURCE, HELP_CONTEXT);
}

void CBirthInfo::showGmtCtl(int bShow)
{
  if ( bShow) {
