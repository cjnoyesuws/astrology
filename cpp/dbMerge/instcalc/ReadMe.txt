========================================================================
    ACTIVE TEMPLATE LIBRARY : instcalc Project Overview
========================================================================

AppWizard has created this instcalc project for you to use as the starting point for
...
_instcalc.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_instcalc.h)
        GUID definitions                                (_instcalc_i.c)
        A type library                                  (_instcalc.tlb)
        Marshaling code                                 (_instcalc_p.c and dlldata.c)
instcalc.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named instcalc.pch and a precompiled types file named StdAfx.obj.
...
instcalcps.vcproj
	...
	dlldata.c, instcalc_i.c and instcalc_p.c which are required
