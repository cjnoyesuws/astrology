...
extern const MIDL_SERVER_INFO IAstInstCalc_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IAstInstCalc_ProxyInfo;
...
/* Object interface: IAstInstCalc, ver. 0.0,
   GUID={0xAE6B81CB,0x38A6,0x4171,{0xB2,0xF2,0xA1,0xF4,0x76,0x58,0xEE,0xE4}} */

#pragma code_seg(".orpc")
static const unsigned short IAstInstCalc_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IAstInstCalc_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IAstInstCalc_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IAstInstCalc_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(10) _IAstInstCalcProxyVtbl = 
{
    &IAstInstCalc_ProxyInfo,
    &IID_IAstInstCalc,
    ...
    (void *) (INT_PTR) -1 /* IAstInstCalc::get_Value */ ,
    (void *) (INT_PTR) -1 /* IAstInstCalc::put_Index */ ,
    (void *) (INT_PTR) -1 /* IAstInstCalc::StartAt */
};


static const PRPC_STUB_FUNCTION IAstInstCalc_table[] =
{
...
CInterfaceStubVtbl _IAstInstCalcStubVtbl =
{
    &IID_IAstInstCalc,
    &IAstInstCalc_ServerInfo,
    10,
    &IAstInstCalc_table[-3],
...
const CInterfaceProxyVtbl * __instcalc_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IAstInstCalcProxyVtbl,
    0
};

const CInterfaceStubVtbl * __instcalc_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAstInstCalcStubVtbl,
    0
};

PCInterfaceName const __instcalc_InterfaceNamesList[] = 
{
    "IAstInstCalc",
    0
};

const IID *  __instcalc_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __instcalc_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __instcalc, pIID, n)

int __stdcall __instcalc_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__instcalc_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _instcalc_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __instcalc_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __instcalc_StubVtblList,
    (const PCInterfaceName * ) & __instcalc_InterfaceNamesList,
    (const IID ** ) & __instcalc_BaseIIDList,
    & __instcalc_IID_Lookup, 
    1,
    2,
