========================================================================
    ACTIVEX CONTROL DLL : TabCtrl Project Overview
========================================================================

ControlWizard has created this project for your TabCtrl ActiveX Control
...
that make up your TabCtrl ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CTabCtrlCtrl control:

TabCtrlCtrl.h
    This file contains the declaration of the CTabCtrlCtrl C++ class.

TabCtrlCtrl.cpp
    This file contains the implementation of the CTabCtrlCtrl C++ class.

TabCtrlPropPage.h
    This file contains the declaration of the CTabCtrlPropPage C++ class.

TabCtrlPropPage.cpp
    This file contains the implementation of the CTabCtrlPropPage C++ class.

CTabCtrlCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CTabCtrlCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file TabCtrl.rc.
...
stdafx.h, stdafx.cpp
    ...
    named TabCtrl.pch and a precompiled types (PCT) file named stdafx.obj.
