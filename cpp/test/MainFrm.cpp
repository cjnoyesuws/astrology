...
#ifdef _UNICODE
extern CStringArray aExportedRept;
extern CStringArray aExportedReg;
extern CStringArray aExportedAsp;
extern CStringArray aExportedHlp;
#endif
...
#ifdef _UNICODE
	  aExportedAsp.RemoveAll();
	  exp.SetArray(&aExportedAsp);
#endif
	  exp.Process();
	}
}
...
#ifdef _UNICODE
	  aExportedHlp.RemoveAll();
	  exp.SetArray(&aExportedHlp);
#endif
	  exp.Process();
	}
}
...
#ifdef _UNICODE
	  aExportedReg.RemoveAll();
	  exp.SetArray(&aExportedReg);
#endif
	  exp.Process();
	}
}
...
#ifdef _UNICODE
	  aExportedRept.RemoveAll();
	  exp.SetArray(&aExportedRept);
#endif
	  exp.Process();
	}
}
